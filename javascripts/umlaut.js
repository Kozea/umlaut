...
var Actor, Aggregation, Arrow, Association, Base, Battery, BlackArrow, Case, Class, ClassDiagram, Comment, Composition, Container, Database, Decision, Delay, Diagram, Diamond, Diode, Document, Electric, ElectricDiagram, Element, Ellipsis, Flow, FlowChart, Group, HardDisk, IO, Inheritance, InternalStorage, Link, Lozenge, ManualInput, Marker, Mouse, NPNTransistor, Node, Note, PNPTransistor, Preparation, Process, Rect, Resistor, ShapeDiagram, SubProcess, Svg, System, Terminator, Transistor, UseCase, Void, WhiteArrow, WhiteDiamond, Wire, anchor_link_drag, angle_to_cardinal, atan2, cardinal, cardinal_to_direction, commands, dist, edit, ellipsis, enter_link, enter_node, generate_url, history_pop, init_commands, link_drag, list_diagrams, load, lozenge, mod2pi, mouse_anchor, mouse_link, mouse_node, mouse_xy, move_drag, node_add, note, nsweo_resize_drag, order, pi, rectangle, rotate, save, tick_link, tick_node, timestamp, to_deg, to_rad, to_svg_angle, uml_elements, uml_links, update_link, update_node, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref25, _ref26, _ref27, _ref28, _ref29, _ref3, _ref30, _ref31, _ref32, _ref33, _ref34, _ref35, _ref36, _ref37, _ref38, _ref39, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
...
Diagram = (function(_super) {
  ...
  Diagram.prototype.loads = function(obj) {
    var element, element_type, elt, group, group_type, grp, link, link_type, lnk, _i, _j, _k, _len, _len1, _len2, _ref3, _ref4, _ref5, _results;
    if (obj.title) {
...
Process = (function(_super) {
  ...
  function Process() {
    _ref20 = Process.__super__.constructor.apply(this, arguments);
    return _ref20;
  }
...
Terminator = (function(_super) {
  ...
  function Terminator() {
    _ref21 = Terminator.__super__.constructor.apply(this, arguments);
    return _ref21;
  }
...
SubProcess = (function(_super) {
  ...
  function SubProcess() {
    _ref22 = SubProcess.__super__.constructor.apply(this, arguments);
    return _ref22;
  }
...
Document = (function(_super) {
  ...
  function Document() {
    _ref23 = Document.__super__.constructor.apply(this, arguments);
    return _ref23;
  }
...
Database = (function(_super) {
  ...
  function Database() {
    _ref24 = Database.__super__.constructor.apply(this, arguments);
    return _ref24;
  }
...
HardDisk = (function(_super) {
  ...
  function HardDisk() {
    _ref25 = HardDisk.__super__.constructor.apply(this, arguments);
    return _ref25;
  }
...
Preparation = (function(_super) {
  ...
  function Preparation() {
    _ref26 = Preparation.__super__.constructor.apply(this, arguments);
    return _ref26;
  }
...
InternalStorage = (function(_super) {
  ...
  function InternalStorage() {
    _ref27 = InternalStorage.__super__.constructor.apply(this, arguments);
    return _ref27;
  }
...
Flow = (function(_super) {
  ...
  function Flow() {
    _ref28 = Flow.__super__.constructor.apply(this, arguments);
    return _ref28;
  }
...
Container = (function(_super) {
  ...
  function Container() {
    _ref29 = Container.__super__.constructor.apply(this, arguments);
    return _ref29;
  }
...
Case = (function(_super) {
  ...
  function Case() {
    _ref30 = Case.__super__.constructor.apply(this, arguments);
    return _ref30;
  }
...
System = (function(_super) {
  ...
  function System() {
    _ref31 = System.__super__.constructor.apply(this, arguments);
    return _ref31;
  }
...
Electric = (function(_super) {
  ...
  function Electric() {
    _ref32 = Electric.__super__.constructor.apply(this, arguments);
    return _ref32;
  }
...
Resistor = (function(_super) {
  ...
  function Resistor() {
    _ref33 = Resistor.__super__.constructor.apply(this, arguments);
    return _ref33;
  }
...
Diode = (function(_super) {
  ...
  function Diode() {
    _ref34 = Diode.__super__.constructor.apply(this, arguments);
    return _ref34;
  }
...
Battery = (function(_super) {
  ...
  function Battery() {
    _ref35 = Battery.__super__.constructor.apply(this, arguments);
    return _ref35;
  }
...
PNPTransistor = (function(_super) {
  ...
  function PNPTransistor() {
    _ref36 = PNPTransistor.__super__.constructor.apply(this, arguments);
    return _ref36;
  }
...
NPNTransistor = (function(_super) {
  ...
  function NPNTransistor() {
    _ref37 = NPNTransistor.__super__.constructor.apply(this, arguments);
    return _ref37;
  }
...
Wire = (function(_super) {
  ...
  function Wire() {
    _ref38 = Wire.__super__.constructor.apply(this, arguments);
    return _ref38;
  }

  Wire.prototype.path = function() {
    var c1, c2, path, _ref39;
    c1 = this.source.pos();
    c2 = this.target.pos();
    if (void 0 === c1.x || void 0 === c1.y || void 0 === c2.x || void 0 === c2.y) {
      return 'M 0 0';
    ...
    if ((_ref39 = angle_to_cardinal(this.source._rotation)) === 'E' || _ref39 === 'W') {
      path = "" + path + " " + this.a2.x + " " + this.a1.y + " L";
    } else {
      path = "" + path + " " + this.a1.x + " " + this.a2.y + " L";
    }
...
Class = (function(_super) {
  ...
  function Class() {
    _ref39 = Class.__super__.constructor.apply(this, arguments);
    return _ref39;
  }
...
commands = {
  ...
  edit: {
    fun: function() {
      return edit((function() {
        ...
        var node, _i, _len, _ref40, _results;
  ...
  remove: {
    fun: function() {
      var lnk, node, _i, _j, _len, _len1, _ref40, _ref41;
      _ref40 = diagram.selection;
      for (_i = 0, _len = _ref40.length; _i < _len; _i++) {
        node = _ref40[_i];
  ...
  snaptogrid: {
    fun: function() {
      var node, _i, _len, _ref40;
      _ref40 = diagram.nodes();
      for (_i = 0, _len = _ref40.length; _i < _len; _i++) {
        node = _ref40[_i];
  ...
  "switch": {
    fun: function() {
      var link, node, _i, _j, _len, _len1, _ref40, _ref41, _ref42, _ref43;
      _ref40 = diagram.selection;
      for (_i = 0, _len = _ref40.length; _i < _len; _i++) {
        node = _ref40[_i];
        if (node instanceof Link) {
          _ref41 = [node.target, node.source], node.source = _ref41[0], node.target = _ref41[1];
        }
        if (node instanceof Element) {
          _ref42 = diagram.links;
          for (_j = 0, _len1 = _ref42.length; _j < _len1; _j++) {
            link = _ref42[_j];
            _ref43 = [link.target, link.source], link.source = _ref43[0], link.target = _ref43[1];
          }
        }
      }
      return svg.tick();
...
init_commands = function() {
  var e, e1, e2, element, fun, hotkey, i, icon, key, l, link, margin, n, svgicon, taken_hotkeys, _i, _j, _len, _len1, _ref40, _ref41, _results;
  taken_hotkeys = [];
  ...
  _ref40 = diagram.types.elements.concat(diagram.types.groups);
  for (_i = 0, _len = _ref40.length; _i < _len; _i++) {
    e = _ref40[_i];
    i = 1;
  ...
  taken_hotkeys = [];
  _ref41 = diagram.types.links;
  _results = [];
  for (n = _j = 0, _len1 = _ref41.length; _j < _len1; n = ++_j) {
    l = _ref41[n];
    i = 1;
...
move_drag = d3.behavior.drag().on('dragstart', function(node) {
  ...
  var delta, x, y, _i, _j, _len, _len1, _ref40, _ref41, _ref42;
  if (!diagram.dragging || d3.event.sourceEvent.ctrlKey) {
    return;
  }
  x = diagram.force ? 'px' : 'x';
  y = diagram.force ? 'py' : 'y';
  if (_ref40 = !node, __indexOf.call(diagram.selection, _ref40) >= 0) {
  ...
  var lnk, _i, _j, _len, _len1, _ref40, _ref41;
...
mouse_anchor = function(anchor) {
  ...
  return anchor.on("mousemove", function(anchor) {
    var lnk, node, _i, _len, _ref40, _results;
    if (d3.event.ctrlKey) {
      return;
    }
    d3.select(this).classed('active', true);
    node = d3.select($(this).closest('.node').get(0)).data()[0];
    _ref40 = diagram.linking;
    _results = [];
    for (_i = 0, _len = _ref40.length; _i < _len; _i++) {
      lnk = _ref40[_i];
    ...
    var lnk, _i, _len, _ref40, _results;
    if (d3.event.ctrlKey) {
      return;
    }
    ...
    var lnk, node, _i, _len, _ref40, _ref41;
    if (d3.event.ctrlKey) {
      return;
    }
    ...
    if (diagram.linking.length) {
      ...
      for (_i = 0, _len = _ref40.length; _i < _len; _i++) {
        lnk = _ref40[_i];
        if (lnk.source !== lnk.target && ((_ref41 = diagram.mouse) !== lnk.source && _ref41 !== lnk.target)) {
...
update_node = function(nodes) {
  nodes.select('text').each(function(node) {
    var i, line, tspan, txt, _i, _len, _ref40, _results;
    txt = d3.select(this);
    if (node.text === txt.text) {
      return;
    }
    txt.selectAll('tspan').remove();
    _ref40 = node.text.split('\n');
    _results = [];
...
Svg = (function(_super) {
  ...
  function Svg() {
    ...
    this.zoom = d3.behavior.zoom().scale(diagram.zoom.scale).translate(diagram.zoom.translate).scaleExtent([.15, 5]).on("zoom", function() {
      var _ref40;
      if (!d3.event.sourceEvent || ((_ref40 = d3.event.sourceEvent.type) === 'wheel' || _ref40 === 'click') || d3.event.sourceEvent.ctrlKey || d3.event.sourceEvent.which === 2) {
...
list_diagrams = function() {
  var $tbody, $tr, $ul, b64_diagram, diagram, key, name, title, type, _ref40, _ref41, _results;
  $tbody = $('#diagrams tbody');
  $tbody.find('.local').remove();
  for (key in localStorage) {
    b64_diagram = localStorage[key];
    _ref40 = key.split('|'), type = _ref40[0], title = _ref40[1];
    if (title == null) {
      continue;
    }
    $tbody.append($tr = $('<tr>'));
