...
var Aggregation, Arrow, Assign, Association, Attribute, Attributes, BRACES, Base, BlackArrow, BlackDiamond, BlackDot, Brace, COMPASS_PTS, Comment, Composition, DELIMITERS, Delimiter, Diagram, Diagrams, E, Edge, Electric, Element, Ellipsis, Graph, Group, Hexagon, House, Id, Inheritance, KEYWORDS, Keyword, L, Link, LinkStyle, LinkStyles, Lozenge, Marker, Mouse, Node, Note, Number, OPERATORS, Octogon, Operator, PANIC_THRESHOLD, Parallelogram, Pentagon, Polygon, QuotedId, RE_ALPHA, RE_ALPHADIGIT, RE_DIGIT, RE_SPACE, Rect, Septagon, Star, Statement, SubGraph, Svg, Token, Transistor, Trapezium, Triangle, Void, WhiteArrow, WhiteDiamond, WhiteDot, anchor_link_drag, angle_to_cardinal, atan2, capitalize, cardinal, cardinal_to_direction, color, commands, copy, dist, dot, dot_lex, dot_tokenize, edit, enter_link, enter_node, generate_url, history_pop, init_commands, last_command, link_drag, list_diagrams, load, merge, merge_copy, mod2pi, mouse_anchor, mouse_link, mouse_node, mouse_xy, move_drag, next, node_add, nsweo_resize_drag, order, pi, rotate, save, tick_link, tick_node, timestamp, to_deg, to_rad, to_svg_angle, update_anchors, update_handles, update_link, update_node, wrap, write_text, zoom, _ref, _ref1, _ref10, _ref100, _ref101, _ref102, _ref103, _ref104, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref25, _ref26, _ref27, _ref28, _ref29, _ref3, _ref30, _ref31, _ref32, _ref33, _ref34, _ref35, _ref36, _ref37, _ref38, _ref39, _ref4, _ref40, _ref41, _ref42, _ref43, _ref44, _ref45, _ref46, _ref47, _ref48, _ref49, _ref5, _ref50, _ref51, _ref52, _ref53, _ref54, _ref55, _ref56, _ref57, _ref58, _ref59, _ref6, _ref60, _ref61, _ref62, _ref63, _ref64, _ref65, _ref66, _ref67, _ref68, _ref69, _ref7, _ref70, _ref71, _ref72, _ref73, _ref74, _ref75, _ref76, _ref77, _ref78, _ref79, _ref8, _ref80, _ref81, _ref82, _ref83, _ref84, _ref85, _ref86, _ref87, _ref88, _ref89, _ref9, _ref90, _ref91, _ref92, _ref93, _ref94, _ref95, _ref96, _ref97, _ref98, _ref99,
...
color = function(attrs) {
  var fill, fillcolor, stroke, style, _ref;
  if (!attrs) {
    return void 0;
  }
  ...
  fillcolor = fillcolor || attrs.fillcolor;
  stroke = ((attrs != null ? attrs.color : void 0) != null) && ("stroke: " + attrs.color + ";");
  fill = (fillcolor != null) && ("fill: " + fillcolor + ";");
  if (fill || stroke) {
    if (fill && stroke) {
      return fill + stroke;
    } else if (fill) {
...
WhiteArrow = (function(_super) {
  ...
  function WhiteArrow() {
    _ref10 = WhiteArrow.__super__.constructor.apply(this, arguments);
    return _ref10;
  }
...
BlackDiamond = (function(_super) {
  ...
  function BlackDiamond() {
    _ref11 = BlackDiamond.__super__.constructor.apply(this, arguments);
    return _ref11;
  }
...
WhiteDiamond = (function(_super) {
  ...
  function WhiteDiamond() {
    _ref12 = WhiteDiamond.__super__.constructor.apply(this, arguments);
    return _ref12;
  }

  WhiteDiamond.fill = 'bg';

  return WhiteDiamond;

})(BlackDiamond);

BlackDot = (function(_super) {
  __extends(BlackDot, _super);

  function BlackDot() {
    _ref13 = BlackDot.__super__.constructor.apply(this, arguments);
    return _ref13;
  }

  BlackDot.prototype.path = function() {
    return 'M 9 5 A 5 5 0 1 1 19 5 A 5 5 0 1 1 9 5';
  };
...
WhiteDot = (function(_super) {
  __extends(WhiteDot, _super);

  function WhiteDot() {
    _ref14 = WhiteDot.__super__.constructor.apply(this, arguments);
    return _ref14;
  }
...
Element = (function(_super) {
  ...
  Element.prototype.direction = function(x, y) {
    var anchor, deviation, diff, min_anchor, min_diff, pi2, pos, target, _ref15;
    pi2 = 2 * pi;
    target = atan2(y - this.y, x - this.x);
    min_diff = Infinity;
    _ref15 = this.anchors;
    for (anchor in _ref15) {
      pos = _ref15[anchor];
  ...
  Element.prototype["in"] = function(rect) {
    var _ref15, _ref16;
    return (rect.x < (_ref15 = this.x) && _ref15 < rect.x + rect.width) && (rect.y < (_ref16 = this.y) && _ref16 < rect.y + rect.height);
  };
...
Diagram = (function(_super) {
  ...
  Diagram.prototype.markers = function() {
    var key, markers, name, type, val, _ref15, _results;
    markers = {};
    _ref15 = this.types.links;
    for (name in _ref15) {
      type = _ref15[name];
  ...
  Diagram.prototype.to_svg = function() {
    var content, css, margin, rect, rule, svg_clone, _i, _len, _ref15;
    css = '';
    _ref15 = d3.select('#style').node().sheet.cssRules;
  ...
  Diagram.prototype.loads = function(obj) {
    var element, element_type, elt, group, group_type, grp, link, link_type, lnk, _i, _j, _k, _len, _len1, _len2, _ref15, _ref16, _ref17;
    if (obj.title) {
    ...
    for (_k = 0, _len2 = _ref17.length; _k < _len2; _k++) {
      lnk = _ref17[_k];
      link_type = this.types.links[lnk.name] || this.types.links[lnk.name.replace('Link', '')];
...
Rect = (function(_super) {
  ...
  function Rect() {
    _ref15 = Rect.__super__.constructor.apply(this, arguments);
    return _ref15;
  }
...
Ellipsis = (function(_super) {
  ...
  function Ellipsis() {
    _ref16 = Ellipsis.__super__.constructor.apply(this, arguments);
    return _ref16;
  }
...
Note = (function(_super) {
  ...
  function Note() {
    _ref17 = Note.__super__.constructor.apply(this, arguments);
    return _ref17;
  }
...
Triangle = (function(_super) {
  ...
  function Triangle() {
    _ref19 = Triangle.__super__.constructor.apply(this, arguments);
    return _ref19;
  }
...
Trapezium = (function(_super) {
  ...
  function Trapezium() {
    _ref20 = Trapezium.__super__.constructor.apply(this, arguments);
    return _ref20;
  }
...
Polygon = (function(_super) {
  ...
  function Polygon() {
    _ref21 = Polygon.__super__.constructor.apply(this, arguments);
    return _ref21;
  }
  ...
  Polygon.prototype.path = function() {
    ...
    h2 = this.height() / 2;
    path = "M 0 " + (-h2);
    for (i = _i = 1, _ref22 = this.n; 1 <= _ref22 ? _i <= _ref22 : _i >= _ref22; i = 1 <= _ref22 ? ++_i : --_i) {
...
Pentagon = (function(_super) {
  ...
  function Pentagon() {
    _ref22 = Pentagon.__super__.constructor.apply(this, arguments);
    return _ref22;
  }
...
Hexagon = (function(_super) {
  ...
  function Hexagon() {
    _ref23 = Hexagon.__super__.constructor.apply(this, arguments);
    return _ref23;
  }
...
Septagon = (function(_super) {
  ...
  function Septagon() {
    _ref24 = Septagon.__super__.constructor.apply(this, arguments);
    return _ref24;
  }
...
Octogon = (function(_super) {
  ...
  function Octogon() {
    _ref25 = Octogon.__super__.constructor.apply(this, arguments);
    return _ref25;
  }
...
Star = (function(_super) {
  ...
  function Star() {
    _ref26 = Star.__super__.constructor.apply(this, arguments);
    return _ref26;
  }
  ...
  Star.prototype.path = function() {
    var angle, h2, i, lh2, lw2, magic, path, w2, _i, _ref27;
    angle = 2 * pi / this.n;
    w2 = this.width() / 2;
    h2 = this.height() / 2;
    magic = 5 * pi / 6;
    ...
    lh2 = h2 / magic;
    path = "M 0 " + (-h2);
    for (i = _i = 0, _ref27 = this.n; 0 <= _ref27 ? _i <= _ref27 : _i >= _ref27; i = 0 <= _ref27 ? ++_i : --_i) {
...
Association = (function(_super) {
  ...
  function Association() {
    _ref27 = Association.__super__.constructor.apply(this, arguments);
    return _ref27;
  }
...
Inheritance = (function(_super) {
  ...
  function Inheritance() {
    _ref28 = Inheritance.__super__.constructor.apply(this, arguments);
    return _ref28;
  }
...
Composition = (function(_super) {
  ...
  function Composition() {
    _ref29 = Composition.__super__.constructor.apply(this, arguments);
    return _ref29;
  }
...
Comment = (function(_super) {
  ...
  function Comment() {
    _ref30 = Comment.__super__.constructor.apply(this, arguments);
    return _ref30;
  }
...
Aggregation = (function(_super) {
  ...
  function Aggregation() {
    _ref31 = Aggregation.__super__.constructor.apply(this, arguments);
    return _ref31;
  }
...
Group = (function(_super) {
  ...
  function Group() {
    _ref32 = Group.__super__.constructor.apply(this, arguments);
    return _ref32;
  }

  Group.prototype.contains = function(elt) {
    var h2, w2, _ref33, _ref34;
    w2 = this.width() / 2;
    h2 = this.height() / 2;
    return (this.x - w2 < (_ref33 = elt.x) && _ref33 < this.x + w2) && (this.y - h2 < (_ref34 = elt.y) && _ref34 < this.y + h2);
  };
...
Diagrams.FlowChart = (function(_super) {
  ...
  function FlowChart() {
    _ref33 = FlowChart.__super__.constructor.apply(this, arguments);
    return _ref33;
  }
...
E.Process = (function(_super) {
  ...
  function Process() {
    _ref34 = Process.__super__.constructor.apply(this, arguments);
    return _ref34;
  }
...
E.IO = (function(_super) {
  ...
  function IO() {
    _ref35 = IO.__super__.constructor.apply(this, arguments);
    return _ref35;
  }
...
E.Box = (function(_super) {
  ...
  function Box() {
    _ref45 = Box.__super__.constructor.apply(this, arguments);
    return _ref45;
  }
...
E.Polygon = (function(_super) {
  ...
  function Polygon() {
    _ref46 = Polygon.__super__.constructor.apply(this, arguments);
    return _ref46;
  }
...
E.Ellipse = (function(_super) {
  ...
  function Ellipse() {
    _ref47 = Ellipse.__super__.constructor.apply(this, arguments);
    return _ref47;
  }
...
E.Oval = (function(_super) {
  ...
  function Oval() {
    _ref48 = Oval.__super__.constructor.apply(this, arguments);
    return _ref48;
  }
...
E.Circle = (function(_super) {
  ...
  function Circle() {
    _ref49 = Circle.__super__.constructor.apply(this, arguments);
    return _ref49;
  }
...
E.Triangle = (function(_super) {
  ...
  function Triangle() {
    _ref50 = Triangle.__super__.constructor.apply(this, arguments);
    return _ref50;
  }

  Triangle.rotationable = true;
...
E.Plaintext = (function(_super) {
  ...
  function Plaintext() {
    _ref51 = Plaintext.__super__.constructor.apply(this, arguments);
    return _ref51;
  }

  Plaintext.rotationable = true;
...
E.Diamond = (function(_super) {
  ...
  function Diamond() {
    _ref52 = Diamond.__super__.constructor.apply(this, arguments);
    return _ref52;
  }
...
E.Trapezium = (function(_super) {
  ...
  function Trapezium() {
    _ref53 = Trapezium.__super__.constructor.apply(this, arguments);
    return _ref53;
  }

  Trapezium.rotationable = true;
...
E.Parallelogram = (function(_super) {
  ...
  function Parallelogram() {
    _ref54 = Parallelogram.__super__.constructor.apply(this, arguments);
    return _ref54;
  }

  Parallelogram.rotationable = true;
...
E.House = (function(_super) {
  ...
  function House() {
    _ref55 = House.__super__.constructor.apply(this, arguments);
    return _ref55;
  }

  House.rotationable = true;
...
E.Pentagon = (function(_super) {
  ...
  function Pentagon() {
    _ref56 = Pentagon.__super__.constructor.apply(this, arguments);
    return _ref56;
  }

  Pentagon.rotationable = true;
...
E.Hexagon = (function(_super) {
  ...
  function Hexagon() {
    _ref57 = Hexagon.__super__.constructor.apply(this, arguments);
    return _ref57;
  }

  Hexagon.rotationable = true;
...
E.Septagon = (function(_super) {
  ...
  function Septagon() {
    _ref58 = Septagon.__super__.constructor.apply(this, arguments);
    return _ref58;
  }

  Septagon.rotationable = true;
...
E.Octogon = (function(_super) {
  ...
  function Octogon() {
    _ref59 = Octogon.__super__.constructor.apply(this, arguments);
    return _ref59;
  }

  Octogon.rotationable = true;
...
E.Rect = (function(_super) {
  ...
  function Rect() {
    _ref60 = Rect.__super__.constructor.apply(this, arguments);
    return _ref60;
  }
...
E.Rectangle = (function(_super) {
  ...
  function Rectangle() {
    _ref61 = Rectangle.__super__.constructor.apply(this, arguments);
    return _ref61;
  }
...
E.Square = (function(_super) {
  ...
  function Square() {
    _ref62 = Square.__super__.constructor.apply(this, arguments);
    return _ref62;
  }
...
E.Star = (function(_super) {
  ...
  function Star() {
    _ref63 = Star.__super__.constructor.apply(this, arguments);
    return _ref63;
  }

  Star.rotationable = true;
...
E.None = (function(_super) {
  ...
  function None() {
    _ref64 = None.__super__.constructor.apply(this, arguments);
    return _ref64;
  }
...
E.Underline = (function(_super) {
  ...
  function Underline() {
    _ref65 = Underline.__super__.constructor.apply(this, arguments);
    return _ref65;
  }

  Underline.rotationable = true;
...
E.Note = (function(_super) {
  ...
  function Note() {
    _ref66 = Note.__super__.constructor.apply(this, arguments);
    return _ref66;
  }
...
L.None = (function(_super) {
  __extends(None, _super);

  function None() {
    _ref67 = None.__super__.constructor.apply(this, arguments);
    return _ref67;
  }
...
L.Curve = (function(_super) {
  __extends(Curve, _super);

  function Curve() {
    _ref68 = Curve.__super__.constructor.apply(this, arguments);
    return _ref68;
  }

  Curve.marker = new Arrow();

  return Curve;

})(Link);

L.Normal = (function(_super) {
  __extends(Normal, _super);

  function Normal() {
    _ref69 = Normal.__super__.constructor.apply(this, arguments);
    return _ref69;
  }

  Normal.marker = new BlackArrow();

  return Normal;

})(Link);

L.Onormal = (function(_super) {
  __extends(Onormal, _super);

  function Onormal() {
    _ref70 = Onormal.__super__.constructor.apply(this, arguments);
    return _ref70;
  }

  Onormal.marker = new WhiteArrow();

  return Onormal;

})(Link);

L.Diamond = (function(_super) {
  __extends(Diamond, _super);

  function Diamond() {
    _ref71 = Diamond.__super__.constructor.apply(this, arguments);
    return _ref71;
  }

  Diamond.marker = new BlackDiamond();

  return Diamond;

})(Link);

L.Odiamond = (function(_super) {
  __extends(Odiamond, _super);

  function Odiamond() {
    _ref72 = Odiamond.__super__.constructor.apply(this, arguments);
    return _ref72;
  }

  Odiamond.marker = new WhiteDiamond();

  return Odiamond;

})(Link);

L.Dot = (function(_super) {
  __extends(Dot, _super);

  function Dot() {
    _ref73 = Dot.__super__.constructor.apply(this, arguments);
    return _ref73;
  }

  Dot.marker = new BlackDot();

  return Dot;

})(Link);

L.Odot = (function(_super) {
  __extends(Odot, _super);

  function Odot() {
    _ref74 = Odot.__super__.constructor.apply(this, arguments);
    return _ref74;
  }

  Odot.marker = new WhiteDot();
...
Diagrams.UseCase.prototype.types.elements.Case = (function(_super) {
  ...
  function Case() {
    _ref75 = Case.__super__.constructor.apply(this, arguments);
    return _ref75;
  }
...
Diagrams.UseCase.prototype.types.groups.System = (function(_super) {
  ...
  function System() {
    _ref76 = System.__super__.constructor.apply(this, arguments);
    return _ref76;
  }
...
Diagrams.UseCase.prototype.types.links.Association = (function(_super) {
  ...
  function Association() {
    _ref77 = Association.__super__.constructor.apply(this, arguments);
    return _ref77;
  }
...
Diagrams.UseCase.prototype.types.links.Inheritance = (function(_super) {
  ...
  function Inheritance() {
    _ref78 = Inheritance.__super__.constructor.apply(this, arguments);
    return _ref78;
  }
...
Diagrams.UseCase.prototype.types.links.Aggregation = (function(_super) {
  ...
  function Aggregation() {
    _ref79 = Aggregation.__super__.constructor.apply(this, arguments);
    return _ref79;
  }
...
Diagrams.UseCase.prototype.types.links.Composition = (function(_super) {
  ...
  function Composition() {
    _ref80 = Composition.__super__.constructor.apply(this, arguments);
    return _ref80;
  }
...
Diagrams.UseCase.prototype.types.links.Comment = (function(_super) {
  ...
  function Comment() {
    _ref81 = Comment.__super__.constructor.apply(this, arguments);
    return _ref81;
  }
...
Electric = (function(_super) {
  ...
  function Electric() {
    _ref82 = Electric.__super__.constructor.apply(this, arguments);
    return _ref82;
  }
...
E.Resistor = (function(_super) {
  ...
  function Resistor() {
    _ref83 = Resistor.__super__.constructor.apply(this, arguments);
    return _ref83;
  }
...
E.Diode = (function(_super) {
  ...
  function Diode() {
    _ref84 = Diode.__super__.constructor.apply(this, arguments);
    return _ref84;
  }
...
E.Battery = (function(_super) {
  ...
  function Battery() {
    _ref85 = Battery.__super__.constructor.apply(this, arguments);
    return _ref85;
  }
...
E.PNPTransistor = (function(_super) {
  ...
  function PNPTransistor() {
    _ref86 = PNPTransistor.__super__.constructor.apply(this, arguments);
    return _ref86;
  }
...
E.NPNTransistor = (function(_super) {
  ...
  function NPNTransistor() {
    _ref87 = NPNTransistor.__super__.constructor.apply(this, arguments);
    return _ref87;
  }
...
Diagrams.Electric.prototype.types.links.Wire = (function(_super) {
  ...
  function Wire() {
    _ref88 = Wire.__super__.constructor.apply(this, arguments);
    return _ref88;
  }
...
Diagrams.Class.prototype.types.elements.Note = (function(_super) {
  ...
  function Note() {
    _ref89 = Note.__super__.constructor.apply(this, arguments);
    return _ref89;
  }
...
Diagrams.Class.prototype.types.elements.Class = (function(_super) {
  ...
  function Class() {
    _ref90 = Class.__super__.constructor.apply(this, arguments);
    return _ref90;
  }
...
Diagrams.Class.prototype.types.groups.System = (function(_super) {
  ...
  function System() {
    _ref91 = System.__super__.constructor.apply(this, arguments);
    return _ref91;
  }
...
L.Association = (function(_super) {
  ...
  function Association() {
    _ref92 = Association.__super__.constructor.apply(this, arguments);
    return _ref92;
  }
...
L.Inheritance = (function(_super) {
  ...
  function Inheritance() {
    _ref93 = Inheritance.__super__.constructor.apply(this, arguments);
    return _ref93;
  }
...
L.Aggregation = (function(_super) {
  ...
  function Aggregation() {
    _ref94 = Aggregation.__super__.constructor.apply(this, arguments);
    return _ref94;
  }
...
L.Composition = (function(_super) {
  ...
  function Composition() {
    _ref95 = Composition.__super__.constructor.apply(this, arguments);
    return _ref95;
  }
...
L.Comment = (function(_super) {
  ...
  function Comment() {
    _ref96 = Comment.__super__.constructor.apply(this, arguments);
    return _ref96;
  }
...
commands = {
  ...
  edit: {
    fun: function() {
      return edit((function() {
        ...
        var node, _i, _len, _ref97, _results;
        _ref97 = diagram.selection;
        _results = [];
        for (_i = 0, _len = _ref97.length; _i < _len; _i++) {
          node = _ref97[_i];
  ...
  remove: {
    fun: function() {
      var lnk, node, _i, _j, _len, _len1, _ref97, _ref98;
      _ref97 = diagram.selection;
      for (_i = 0, _len = _ref97.length; _i < _len; _i++) {
        node = _ref97[_i];
        ...
        _ref98 = diagram.links.slice();
        for (_j = 0, _len1 = _ref98.length; _j < _len1; _j++) {
          lnk = _ref98[_j];
  ...
  snaptogrid: {
    fun: function() {
      var node, _i, _len, _ref97;
      _ref97 = diagram.nodes();
      for (_i = 0, _len = _ref97.length; _i < _len; _i++) {
        node = _ref97[_i];
  ...
  "switch": {
    fun: function() {
      var link, node, _i, _j, _len, _len1, _ref100, _ref97, _ref98, _ref99;
      _ref97 = diagram.selection;
      for (_i = 0, _len = _ref97.length; _i < _len; _i++) {
        node = _ref97[_i];
        if (node instanceof Link) {
          _ref98 = [node.target, node.source], node.source = _ref98[0], node.target = _ref98[1];
        }
        if (node instanceof Element) {
          _ref99 = diagram.links;
          for (_j = 0, _len1 = _ref99.length; _j < _len1; _j++) {
            link = _ref99[_j];
            _ref100 = [link.target, link.source], link.source = _ref100[0], link.target = _ref100[1];
          }
        }
      }
      return svg.tick();
...
init_commands = function() {
  var cls, conf, e1, e2, element, first, fun, hotkey, i, icon, inc, key, link, margin, name, svgicon, taken_hotkeys, val, way, _ref100, _ref97, _ref98, _ref99, _results;
  _ref97 = diagram.force_conf;
  for (conf in _ref97) {
    val = _ref97[conf];
    _ref98 = {
      increase: 1.1,
  ...
  _ref99 = merge_copy(diagram.types.elements, diagram.types.groups);
  for (name in _ref99) {
    cls = _ref99[name];
    if (cls.alias) {
      continue;
...
edit = function(getter, setter) {
  ...
  textarea.on('input', function() {
    var val;
    setter(((function() {
      var _i, _len, _ref97, _results;
      _ref97 = this.value.split('\n');
      _results = [];
      for (_i = 0, _len = _ref97.length; _i < _len; _i++) {
        val = _ref97[_i];
        _results.push(val || ' ');
...
move_drag = d3.behavior.drag().origin(function(i) {
  ...
  var delta, nod, x, y, _i, _j, _len, _len1, _ref97, _ref98, _ref99;
  if (!diagram.dragging || d3.event.sourceEvent.ctrlKey) {
    return;
  }
  x = diagram.force ? 'px' : 'x';
  y = diagram.force ? 'py' : 'y';
  if (_ref97 = !node, __indexOf.call(diagram.selection, _ref97) >= 0) {
    diagram.selection.push(node);
  }
  _ref98 = diagram.selection;
  for (_i = 0, _len = _ref98.length; _i < _len; _i++) {
    nod = _ref98[_i];
    nod.fixed = true;
  }
  ...
  var lnk, _i, _j, _len, _len1, _ref97, _ref98;
...
mouse_anchor = function(anchor) {
  ...
  return anchor.on("mousemove", function(anchor) {
    var lnk, node, _i, _len, _ref97, _results;
    if (d3.event.ctrlKey) {
      return;
    }
    d3.select(this).classed('active', true);
    node = d3.select($(this).closest('.node').get(0)).data()[0];
    _ref97 = diagram.linking;
    _results = [];
    for (_i = 0, _len = _ref97.length; _i < _len; _i++) {
      lnk = _ref97[_i];
    ...
    var lnk, _i, _len, _ref97, _results;
    if (d3.event.ctrlKey) {
      return;
    }
    ...
    var lnk, node, _i, _len, _ref97, _ref98;
    if (d3.event.ctrlKey) {
      return;
    }
    ...
    if (diagram.linking.length) {
      ...
      for (_i = 0, _len = _ref97.length; _i < _len; _i++) {
        lnk = _ref97[_i];
        if ((_ref98 = diagram.mouse) !== lnk.source && _ref98 !== lnk.target) {
...
write_text = function(txt, text) {
  var i, line, tspan, _i, _len, _ref97, _results;
  txt.selectAll('tspan').remove();
  _ref97 = text.split('\n');
  _results = [];
  for (i = _i = 0, _len = _ref97.length; _i < _len; i = ++_i) {
    line = _ref97[i];
...
update_link = function(links) {
  links.each(function(link) {
    ...
    return g.select('.shape').attr('style', color(link.attrs));
  });
...
Svg = (function(_super) {
  ...
  function Svg() {
    ...
    this.zoom = zoom.scale(diagram.zoom.scale).translate(diagram.zoom.translate).scaleExtent([.05, 5]).on("zoom", function() {
      var _ref97;
      if (((_ref97 = d3.event.sourceEvent.type) === 'wheel' || _ref97 === 'click') || d3.event.sourceEvent.ctrlKey || d3.event.sourceEvent.which === 2) {
    ...
    markers.enter().append('marker').attr('id', function(m) {
      ...
      return "marker fill-" + m.cls.fill + " stroke-" + m.cls.stroke;
  ...
  if (location.search === '?nocatch/') {
    ...
    try {
      ...
      try {
        ...
        link = Diagrams.Dot.prototype.types.links.Normal;
        window.svg = new Svg();
...
list_diagrams = function() {
  var $tbody, $tr, b64_diagram, diagram, key, name, title, type, _ref97, _results;
  $tbody = $('#diagrams tbody');
  $tbody.find('.local').remove();
  for (key in localStorage) {
    b64_diagram = localStorage[key];
    _ref97 = key.split('|'), type = _ref97[0], title = _ref97[1];
    if (title == null) {
      continue;
    }
    $tbody.append($tr = $('<tr>'));
...
Keyword = (function(_super) {
  ...
  function Keyword() {
    _ref97 = Keyword.__super__.constructor.apply(this, arguments);
    return _ref97;
  }
...
Id = (function(_super) {
  ...
  function Id() {
    _ref98 = Id.__super__.constructor.apply(this, arguments);
    return _ref98;
  }
...
Number = (function(_super) {
  ...
  function Number() {
    _ref99 = Number.__super__.constructor.apply(this, arguments);
    return _ref99;
  }
...
QuotedId = (function(_super) {
  ...
  function QuotedId() {
    _ref100 = QuotedId.__super__.constructor.apply(this, arguments);
    return _ref100;
  }
...
Brace = (function(_super) {
  ...
  function Brace() {
    _ref101 = Brace.__super__.constructor.apply(this, arguments);
    return _ref101;
  }
...
Delimiter = (function(_super) {
  ...
  function Delimiter() {
    _ref102 = Delimiter.__super__.constructor.apply(this, arguments);
    return _ref102;
  }
...
Assign = (function(_super) {
  ...
  function Assign() {
    _ref103 = Assign.__super__.constructor.apply(this, arguments);
    return _ref103;
  }
...
Operator = (function(_super) {
  ...
  function Operator() {
    _ref104 = Operator.__super__.constructor.apply(this, arguments);
    return _ref104;
  }
...
dot_tokenize = function(s) {
  var chr, col, escape, id, last_chr, len, op, pos, row, token, tokens, _ref105, _ref106;
  pos = 0;
  row = 0;
  col = 0;
  len = s.length;
  ...
  while (pos < len) {
    ...
    if (chr.match(/\s/)) {
      ...
      id = chr;
      while ((_ref105 = (chr = s[pos++])) != null ? _ref105.match(/\w/) : void 0) {
        id += chr;
      }
      pos--;
      ...
      id = chr;
      while ((_ref106 = (chr = s[pos++])) != null ? _ref106.match(/\d|\./) : void 0) {
        id += chr;
      }
      pos--;
...
Statement = (function() {
  ...
  Statement.prototype.get_attrs = function() {
    var attribute, attrs, _i, _len, _ref105;
    attrs = {};
    _ref105 = this.attributes;
    for (_i = 0, _len = _ref105.length; _i < _len; _i++) {
      attribute = _ref105[_i];
...
dot_lex = function(tokens) {
  ...
  parse_node = function() {
    var compass_pt, node, port, _ref105;
    if (tokens[pos] instanceof Keyword && tokens[pos].value === 'subgraph') {
      node = parse_subgraph();
      ...
      if (tokens[pos + 1] instanceof Delimiter && tokens[pos + 1].value === ':') {
        ...
        if (tokens[pos + 1] instanceof Delimiter && tokens[pos + 1].value === ':') {
          pos += 2;
          if (!(tokens[pos] instanceof Id) || (_ref105 = tokens[pos].value, __indexOf.call(COMPASS_PTS, _ref105) < 0)) {
  ...
  parse_statement = function() {
    var left, statement, _ref105;
    if (tokens[pos] instanceof Brace && tokens[pos].value === '}') {
      return null;
    }
    if (tokens[pos] instanceof Keyword && tokens[pos].value !== 'subgraph') {
      if ((_ref105 = tokens[pos].value) !== 'graph' && _ref105 !== 'node' && _ref105 !== 'edge') {
  ...
  populate = function(statements) {
    ...
    for (_i = 0, _len = statements.length; _i < _len; _i++) {
      ...
      _results.push((function() {
        var _j, _len1, _ref105, _results1;
        _ref105 = statement.nodes;
        _results1 = [];
        for (i = _j = 0, _len1 = _ref105.length; _j < _len1; i = ++_j) {
          node = _ref105[i];
          ...
          if (i !== 0) {
            ...
            ltype = d.types.links[capitalize(current_attributes.edge.arrowhead || link_type)] || d.types.links.None;
            if (prev_node instanceof SubGraph) {
              _results1.push((function() {
                var _k, _len2, _ref106, _results2;
                _ref106 = prev_node.statements;
                _results2 = [];
                for (_k = 0, _len2 = _ref106.length; _k < _len2; _k++) {
                  sub_prev_statement = _ref106[_k];
                  _results2.push((function() {
                    var _l, _len3, _ref107, _results3;
                    _ref107 = sub_prev_statement.nodes;
                    _results3 = [];
                    for (_l = 0, _len3 = _ref107.length; _l < _len3; _l++) {
                      sub_prev_node = _ref107[_l];
                      if (node instanceof SubGraph) {
                        _results3.push((function() {
                          var _len4, _m, _ref108, _results4;
                          _ref108 = node.statements;
                          _results4 = [];
                          for (_m = 0, _len4 = _ref108.length; _m < _len4; _m++) {
                            sub_statement = _ref108[_m];
                            _results4.push((function() {
                              var _len5, _n, _ref109, _results5;
                              _ref109 = sub_statement.nodes;
                              _results5 = [];
                              for (_n = 0, _len5 = _ref109.length; _n < _len5; _n++) {
                                sub_node = _ref109[_n];
              ...
              if (node instanceof SubGraph) {
                _results1.push((function() {
                  var _k, _len2, _ref106, _results2;
                  _ref106 = node.statements;
                  _results2 = [];
                  for (_k = 0, _len2 = _ref106.length; _k < _len2; _k++) {
                    sub_statement = _ref106[_k];
                    _results2.push((function() {
                      var _l, _len3, _ref107, _results3;
                      _ref107 = sub_statement.nodes;
                      _results3 = [];
                      for (_l = 0, _len3 = _ref107.length; _l < _len3; _l++) {
                        sub_node = _ref107[_l];
                        _results3.push(links_by_id.push({
