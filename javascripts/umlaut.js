...
Element = (function(_super) {
  ...
  Element.prototype.rotate = function(pos, direct) {
    ...
    ang = direct ? this._rotation : 360 - this._rotation;
    normed = {
      x: pos.x - this.x,
      y: pos.y - this.y
    };
...
Wire = (function(_super) {
  ...
  Wire.prototype.path = function() {
    ...
    if (this.source._rotation < 45 || (135 < (_ref38 = this.source._rotation) && _ref38 < 225) || this.source._rotation > 315) {
      path = "" + path + " " + this.a2.x + " " + this.a1.y + " L";
    } else {
      path = "" + path + " " + this.a1.x + " " + this.a2.y + " L";
    }
