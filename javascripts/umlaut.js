...
Diagram = (function(_super) {
  ...
  Diagram.prototype.loads = function(obj) {
    var element, element_type, elt, link, link_type, lnk, _i, _j, _len, _len1, _ref, _ref1;
    if (obj.title) {
...
commands = {
  ...
  remove: {
    fun: function() {
      var lnk, node, _i, _j, _len, _len1, _ref, _ref1;
      _ref = diagram.selection;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        node = _ref[_i];
