...
Diagram = (function(_super) {
  ...
  Diagram.prototype.start_force = function() {
    var _this = this;
    this.force = d3.layout.force().gravity(.7).linkDistance(200).charge(function(node) {
...
Brace = (function(_super) {
  ...
  function Brace() {
    _ref50 = Brace.__super__.constructor.apply(this, arguments);
    return _ref50;
  }
...
Delimiter = (function(_super) {
  ...
  function Delimiter() {
    _ref51 = Delimiter.__super__.constructor.apply(this, arguments);
    return _ref51;
  }
...
Assign = (function(_super) {
  ...
  function Assign() {
    _ref52 = Assign.__super__.constructor.apply(this, arguments);
    return _ref52;
  }
...
Operator = (function(_super) {
  ...
  function Operator() {
    _ref53 = Operator.__super__.constructor.apply(this, arguments);
    return _ref53;
  }
...
tokenize = function(s) {
  var chr, id, last_chr, len, op, pos, token, tokens;
  pos = 0;
  len = s.length;
  tokens = [];
  last_chr = chr = null;
...
parse = function(tokens) {
  var graph, id, level, parse_attribute, parse_attribute_list, parse_edge_node_list, parse_statement, parse_statement_list, parse_subgraph, pos, strict, type;
  pos = 0;
  level = 0;
  ...
  parse_edge_node_list = function(first_elt) {
    var node, node_list;
    node_list = [first_elt];
  ...
  parse_statement = function() {
    ...
    if (tokens[pos] instanceof Keyword) {
      ...
      } else if ((_ref54 = tokens[pos].value) === 'graph' || _ref54 === 'node' || _ref54 === 'edge') {
...
dot = function(src) {
  var d, edge, graph, i, link, mknode, node, nodes_by_id, statement, tokens, _i, _j, _len, _len1, _ref54, _ref55;
  mknode = function(l) {
