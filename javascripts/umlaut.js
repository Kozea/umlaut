...
LinkStyles.Demicurve = (function(_super) {
  ...
  function Demicurve() {
    _ref3 = Demicurve.__super__.constructor.apply(this, arguments);
    return _ref3;
  }
...
LinkStyles.Curve = (function(_super) {
  ...
  function Curve() {
    _ref4 = Curve.__super__.constructor.apply(this, arguments);
    return _ref4;
  }
...
LinkStyles.Rationalcurve = (function(_super) {
  ...
  function Rationalcurve() {
    _ref5 = Rationalcurve.__super__.constructor.apply(this, arguments);
    return _ref5;
  }
...
Element = (function(_super) {
  ...
  Element.prototype.direction = function(x, y) {
    var anchor, deviation, diff, min_anchor, min_diff, pi2, pos, target, _ref6;
    pi2 = 2 * pi;
  ...
  Element.prototype["in"] = function(rect) {
    var _ref6, _ref7;
    return (rect.x < (_ref6 = this.x) && _ref6 < rect.x + rect.width) && (rect.y < (_ref7 = this.y) && _ref7 < rect.y + rect.height);
  };
...
Void = (function(_super) {
  ...
  function Void() {
    _ref6 = Void.__super__.constructor.apply(this, arguments);
    return _ref6;
  }
...
Arrow = (function(_super) {
  ...
  function Arrow() {
    _ref7 = Arrow.__super__.constructor.apply(this, arguments);
    return _ref7;
  }
...
BlackArrow = (function(_super) {
  ...
  function BlackArrow() {
    _ref8 = BlackArrow.__super__.constructor.apply(this, arguments);
    return _ref8;
  }
...
Diagram = (function(_super) {
  ...
  Diagram.prototype.markers = function() {
    var key, markers, type, val, _i, _len, _ref9, _results;
    markers = {};
    _ref9 = this.types.links;
  ...
  Diagram.prototype.group = function(name) {
    var grp, _i, _len, _ref9;
    _ref9 = this.types.groups;
    for (_i = 0, _len = _ref9.length; _i < _len; _i++) {
      grp = _ref9[_i];
      if (grp.name === name) {
        return grp;
  ...
  Diagram.prototype.loads = function(obj) {
    var element, element_type, elt, group, group_type, grp, link, link_type, lnk, _i, _j, _k, _len, _len1, _len2, _ref10, _ref11, _ref9;
    if (obj.title) {
...
Rect = (function(_super) {
  ...
  function Rect() {
    _ref9 = Rect.__super__.constructor.apply(this, arguments);
    return _ref9;
  }
...
Ellipsis = (function(_super) {
  ...
  function Ellipsis() {
    _ref10 = Ellipsis.__super__.constructor.apply(this, arguments);
    return _ref10;
  }
...
Note = (function(_super) {
  ...
  function Note() {
    _ref11 = Note.__super__.constructor.apply(this, arguments);
    return _ref11;
  }
...
Lozenge = (function(_super) {
  ...
  function Lozenge() {
    _ref12 = Lozenge.__super__.constructor.apply(this, arguments);
    return _ref12;
  }
...
WhiteArrow = (function(_super) {
  ...
  function WhiteArrow() {
    _ref13 = WhiteArrow.__super__.constructor.apply(this, arguments);
    return _ref13;
  }
...
BlackDiamond = (function(_super) {
  ...
  function BlackDiamond() {
    _ref14 = BlackDiamond.__super__.constructor.apply(this, arguments);
    return _ref14;
  }
...
WhiteDiamond = (function(_super) {
  ...
  function WhiteDiamond() {
    _ref15 = WhiteDiamond.__super__.constructor.apply(this, arguments);
    return _ref15;
  }
...
Association = (function(_super) {
  ...
  function Association() {
    _ref16 = Association.__super__.constructor.apply(this, arguments);
    return _ref16;
  }
...
Inheritance = (function(_super) {
  ...
  function Inheritance() {
    _ref17 = Inheritance.__super__.constructor.apply(this, arguments);
    return _ref17;
  }
...
Composition = (function(_super) {
  ...
  function Composition() {
    _ref18 = Composition.__super__.constructor.apply(this, arguments);
    return _ref18;
  }
...
Comment = (function(_super) {
  ...
  function Comment() {
    _ref19 = Comment.__super__.constructor.apply(this, arguments);
    return _ref19;
  }
...
Aggregation = (function(_super) {
  ...
  function Aggregation() {
    _ref20 = Aggregation.__super__.constructor.apply(this, arguments);
    return _ref20;
  }
...
Group = (function(_super) {
  ...
  function Group() {
    _ref21 = Group.__super__.constructor.apply(this, arguments);
    return _ref21;
  }

  Group.prototype.contains = function(elt) {
    var h2, w2, _ref22, _ref23;
    w2 = this.width() / 2;
    h2 = this.height() / 2;
    return (this.x - w2 < (_ref22 = elt.x) && _ref22 < this.x + w2) && (this.y - h2 < (_ref23 = elt.y) && _ref23 < this.y + h2);
  };
...
Box = (function(_super) {
  ...
  function Box() {
    _ref22 = Box.__super__.constructor.apply(this, arguments);
    return _ref22;
  }
...
Polygon = (function(_super) {
  ...
  function Polygon() {
    _ref23 = Polygon.__super__.constructor.apply(this, arguments);
    return _ref23;
  }
...
Ellipse = (function(_super) {
  ...
  function Ellipse() {
    _ref24 = Ellipse.__super__.constructor.apply(this, arguments);
    return _ref24;
  }
...
Oval = (function(_super) {
  ...
  function Oval() {
    _ref25 = Oval.__super__.constructor.apply(this, arguments);
    return _ref25;
  }
...
Diamond = (function(_super) {
  ...
  function Diamond() {
    _ref26 = Diamond.__super__.constructor.apply(this, arguments);
    return _ref26;
  }
...
Note = (function(_super) {
  ...
  function Note() {
    _ref27 = Note.__super__.constructor.apply(this, arguments);
    return _ref27;
  }
...
bare_link = (function(_super) {
  ...
  function bare_link() {
    _ref28 = bare_link.__super__.constructor.apply(this, arguments);
    return _ref28;
  }
...
arrow = (function(_super) {
  ...
  function arrow() {
    _ref29 = arrow.__super__.constructor.apply(this, arguments);
    return _ref29;
  }
...
blackarrow = (function(_super) {
  ...
  function blackarrow() {
    _ref30 = blackarrow.__super__.constructor.apply(this, arguments);
    return _ref30;
  }
...
whitearrow = (function(_super) {
  ...
  function whitearrow() {
    _ref31 = whitearrow.__super__.constructor.apply(this, arguments);
    return _ref31;
  }
...
blackdiamond = (function(_super) {
  ...
  function blackdiamond() {
    _ref32 = blackdiamond.__super__.constructor.apply(this, arguments);
    return _ref32;
  }
...
whitediamond = (function(_super) {
  ...
  function whitediamond() {
    _ref33 = whitediamond.__super__.constructor.apply(this, arguments);
    return _ref33;
  }
...
dotted = (function(_super) {
  ...
  function dotted() {
    _ref34 = dotted.__super__.constructor.apply(this, arguments);
    return _ref34;
  }
...
commands = {
  ...
  "export": {
    fun: function(e) {
      var content, css, rule, svg, _i, _len, _ref55;
      css = '';
      _ref55 = d3.select('#style').node().sheet.cssRules;
...
init_commands = function() {
  var e, e1, e2, element, fun, hotkey, i, icon, key, l, link, margin, n, svgicon, taken_hotkeys, _i, _j, _len, _len1, _ref55, _ref56, _results;
  taken_hotkeys = [];
  ...
  _ref55 = diagram.types.elements.concat(diagram.types.groups);
  for (_i = 0, _len = _ref55.length; _i < _len; _i++) {
    e = _ref55[_i];
    i = 1;
  ...
  taken_hotkeys = [];
  _ref56 = diagram.types.links;
  _results = [];
  for (n = _j = 0, _len1 = _ref56.length; _j < _len1; n = ++_j) {
    l = _ref56[n];
    i = 1;
...
Svg = (function(_super) {
  ...
  function Svg() {
    ...
    this.zoom = zoom.scale(diagram.zoom.scale).translate(diagram.zoom.translate).scaleExtent([.05, 5]).on("zoom", function() {
      var _ref55;
      if (!d3.event.sourceEvent || ((_ref55 = d3.event.sourceEvent.type) === 'wheel' || _ref55 === 'click') || d3.event.sourceEvent.ctrlKey || d3.event.sourceEvent.which === 2) {
...
list_diagrams = function() {
  var $tbody, $tr, $ul, b64_diagram, diagram, key, name, title, type, _ref55, _ref56, _results;
  ...
  populate = function(statements) {
    ...
    for (_i = 0, _len = statements.length; _i < _len; _i++) {
      ...
      _results.push((function() {
        var _j, _k, _len1, _len2, _ref63, _ref64, _results1;
          ...
          if (i !== 0) {
            ...
            if (prev_node instanceof SubGraph) {
              _results1.push((function() {
                var _l, _len3, _ref65, _results2;
                _ref65 = prev_node.statements;
                _results2 = [];
                for (_l = 0, _len3 = _ref65.length; _l < _len3; _l++) {
                  sub_prev_statement = _ref65[_l];
                  _results2.push((function() {
                    var _len4, _m, _ref66, _results3;
                    _ref66 = sub_prev_statement.nodes;
                    _results3 = [];
                    for (_m = 0, _len4 = _ref66.length; _m < _len4; _m++) {
                      sub_prev_node = _ref66[_m];
                      if (node instanceof SubGraph) {
                        _results3.push((function() {
                          var _len5, _n, _ref67, _results4;
                          _ref67 = node.statements;
                          _results4 = [];
                          for (_n = 0, _len5 = _ref67.length; _n < _len5; _n++) {
                            sub_statement = _ref67[_n];
                            _results4.push((function() {
                              var _len6, _o, _ref68, _results5;
                              _ref68 = sub_statement.nodes;
                              _results5 = [];
                              for (_o = 0, _len6 = _ref68.length; _o < _len6; _o++) {
                                sub_node = _ref68[_o];
              ...
              if (node instanceof SubGraph) {
                _results1.push((function() {
                  var _l, _len3, _ref65, _results2;
                  _ref65 = node.statements;
                  _results2 = [];
                  for (_l = 0, _len3 = _ref65.length; _l < _len3; _l++) {
                    sub_statement = _ref65[_l];
                    _results2.push((function() {
                      var _len4, _m, _ref66, _results3;
                      _ref66 = sub_statement.nodes;
                      _results3 = [];
                      for (_m = 0, _len4 = _ref66.length; _m < _len4; _m++) {
                        sub_node = _ref66[_m];
