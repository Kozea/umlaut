...
var Aggregation, Assign, Association, Attribute, Attributes, BRACES, Base, Brace, COMPASS_PTS, Comment, Composition, DELIMITERS, Delimiter, Diagram, Diagrams, E, Edge, Electric, Element, Ellipsis, Graph, Group, Hexagon, House, Id, Inheritance, KEYWORDS, Keyword, L, Link, LinkStyle, LinkStyles, Lozenge, Marker, Markers, Mouse, Node, Note, Number, OPERATORS, Octogon, Operator, PANIC_THRESHOLD, Parallelogram, Pentagon, Polygon, QuotedId, RE_ALPHA, RE_ALPHADIGIT, RE_COMMENT, RE_DIGIT, RE_SPACE, Rect, RemoteStorage, Septagon, Star, Statement, SubGraph, Svg, Token, Transistor, Trapezium, Triangle, anchor_link_drag, angle_to_cardinal, atan2, capitalize, cardinal, cardinal_to_direction, commands, copy, dist, dot, dot_lex, dot_tokenize, edit, enter_link, enter_marker, enter_node, generate_url, history_pop, init_commands, last_command, link_drag, list_diagrams, list_local, list_new, list_remote, load, merge, merge_copy, mod2pi, mouse_anchor, mouse_link, mouse_node, mouse_xy, move_drag, n, next, node_add, node_style, nsweo_resize_drag, order, pi, publish, remoteStorage, rotate, save, t, text_style, tick_link, tick_node, timestamp, to_deg, to_rad, to_svg_angle, update_anchors, update_handles, update_link, update_marker, update_node, wrap, write_text, zoom, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref25, _ref26, _ref27, _ref28, _ref29, _ref3, _ref30, _ref31, _ref32, _ref33, _ref34, _ref35, _ref36, _ref37, _ref38, _ref39, _ref4, _ref40, _ref41, _ref42, _ref43, _ref44, _ref45, _ref46, _ref47, _ref48, _ref49, _ref5, _ref50, _ref51, _ref52, _ref53, _ref54, _ref55, _ref56, _ref57, _ref58, _ref59, _ref6, _ref60, _ref61, _ref62, _ref63, _ref64, _ref65, _ref66, _ref67, _ref68, _ref69, _ref7, _ref70, _ref71, _ref72, _ref73, _ref74, _ref75, _ref76, _ref77, _ref78, _ref79, _ref8, _ref80, _ref81, _ref82, _ref83, _ref84, _ref85, _ref86, _ref87, _ref88, _ref89, _ref9, _ref90, _ref91, _ref92, _ref93, _ref94, _ref95, _ref96, _ref97, _ref98,
...
Element = (function(_super) {
  ...
  Element.prototype["in"] = function(rect) {
    var _ref16, _ref17;
    return (rect.x < (_ref16 = this.x) && _ref16 < rect.x + rect.width) && (rect.y < (_ref17 = this.y) && _ref17 < rect.y + rect.height);
  };
...
Diagram = (function(_super) {
  ...
  Diagram.prototype.markers = function() {
    var key, markers, name, type, val, _ref16, _results;
    markers = {};
    _ref16 = this.types.links;
    for (name in _ref16) {
      type = _ref16[name];
  ...
  Diagram.prototype.to_svg = function() {
    var content, css, margin, rect, rule, svg_clone, _i, _len, _ref16;
    css = '';
    _ref16 = d3.select('#style').node().sheet.cssRules;
  ...
  Diagram.prototype.loads = function(obj) {
    var element, element_type, elt, group, group_type, grp, link, link_type, lnk, _i, _j, _k, _len, _len1, _len2, _ref16, _ref17, _ref18, _ref19, _ref20;
    if (obj.title) {
    ...
    for (_k = 0, _len2 = _ref18.length; _k < _len2; _k++) {
      ...
      if ((_ref19 = link.attrs) != null ? _ref19.arrowhead : void 0) {
        link.marker_end = Markers._get(link.attrs.arrowhead);
      }
      if ((_ref20 = link.attrs) != null ? _ref20.arrowtail : void 0) {
...
Rect = (function(_super) {
  ...
  function Rect() {
    _ref16 = Rect.__super__.constructor.apply(this, arguments);
    return _ref16;
  }
...
Note = (function(_super) {
  ...
  function Note() {
    _ref18 = Note.__super__.constructor.apply(this, arguments);
    return _ref18;
  }
...
Lozenge = (function(_super) {
  ...
  function Lozenge() {
    _ref19 = Lozenge.__super__.constructor.apply(this, arguments);
    return _ref19;
  }
...
Triangle = (function(_super) {
  ...
  function Triangle() {
    _ref20 = Triangle.__super__.constructor.apply(this, arguments);
    return _ref20;
  }
...
Trapezium = (function(_super) {
  ...
  function Trapezium() {
    _ref21 = Trapezium.__super__.constructor.apply(this, arguments);
    return _ref21;
  }
...
Pentagon = (function(_super) {
  ...
  function Pentagon() {
    _ref23 = Pentagon.__super__.constructor.apply(this, arguments);
    return _ref23;
  }
...
Hexagon = (function(_super) {
  ...
  function Hexagon() {
    _ref24 = Hexagon.__super__.constructor.apply(this, arguments);
    return _ref24;
  }
...
Septagon = (function(_super) {
  ...
  function Septagon() {
    _ref25 = Septagon.__super__.constructor.apply(this, arguments);
    return _ref25;
  }
...
Octogon = (function(_super) {
  ...
  function Octogon() {
    _ref26 = Octogon.__super__.constructor.apply(this, arguments);
    return _ref26;
  }
...
Star = (function(_super) {
  ...
  function Star() {
    _ref27 = Star.__super__.constructor.apply(this, arguments);
    return _ref27;
  }
  ...
  Star.prototype.path = function() {
    var angle, h2, i, lh2, lw2, magic, path, w2, _i, _ref28;
    angle = 2 * pi / this.n;
    w2 = this.width() / 2;
    h2 = this.height() / 2;
    magic = 5 * pi / 6;
    ...
    lh2 = h2 / magic;
    path = "M 0 " + (-h2);
    for (i = _i = 0, _ref28 = this.n; 0 <= _ref28 ? _i <= _ref28 : _i >= _ref28; i = 0 <= _ref28 ? ++_i : --_i) {
...
Association = (function(_super) {
  ...
  function Association() {
    _ref28 = Association.__super__.constructor.apply(this, arguments);
    return _ref28;
  }
...
Inheritance = (function(_super) {
  ...
  function Inheritance() {
    _ref29 = Inheritance.__super__.constructor.apply(this, arguments);
    return _ref29;
  }
...
Composition = (function(_super) {
  ...
  function Composition() {
    _ref30 = Composition.__super__.constructor.apply(this, arguments);
    return _ref30;
  }
...
Comment = (function(_super) {
  ...
  function Comment() {
    _ref31 = Comment.__super__.constructor.apply(this, arguments);
    return _ref31;
  }
...
Aggregation = (function(_super) {
  ...
  function Aggregation() {
    _ref32 = Aggregation.__super__.constructor.apply(this, arguments);
    return _ref32;
  }
...
Group = (function(_super) {
  ...
  function Group() {
    _ref33 = Group.__super__.constructor.apply(this, arguments);
    return _ref33;
  }

  Group.prototype.contains = function(elt) {
    var h2, w2, _ref34, _ref35;
    w2 = this.width() / 2;
    h2 = this.height() / 2;
    return (this.x - w2 < (_ref34 = elt.x) && _ref34 < this.x + w2) && (this.y - h2 < (_ref35 = elt.y) && _ref35 < this.y + h2);
  };
...
Diagrams.FlowChart = (function(_super) {
  ...
  function FlowChart() {
    _ref34 = FlowChart.__super__.constructor.apply(this, arguments);
    return _ref34;
  }
...
E.IO = (function(_super) {
  ...
  function IO() {
    _ref36 = IO.__super__.constructor.apply(this, arguments);
    return _ref36;
  }
...
E.Terminator = (function(_super) {
  ...
  function Terminator() {
    _ref37 = Terminator.__super__.constructor.apply(this, arguments);
    return _ref37;
  }
...
E.SubProcess = (function(_super) {
  ...
  function SubProcess() {
    _ref38 = SubProcess.__super__.constructor.apply(this, arguments);
    return _ref38;
  }
...
E.Document = (function(_super) {
  ...
  function Document() {
    _ref39 = Document.__super__.constructor.apply(this, arguments);
    return _ref39;
  }
...
E.Database = (function(_super) {
  ...
  function Database() {
    _ref40 = Database.__super__.constructor.apply(this, arguments);
    return _ref40;
  }
...
E.HardDisk = (function(_super) {
  ...
  function HardDisk() {
    _ref41 = HardDisk.__super__.constructor.apply(this, arguments);
    return _ref41;
  }
...
E.Preparation = (function(_super) {
  ...
  function Preparation() {
    _ref42 = Preparation.__super__.constructor.apply(this, arguments);
    return _ref42;
  }
...
E.InternalStorage = (function(_super) {
  ...
  function InternalStorage() {
    _ref43 = InternalStorage.__super__.constructor.apply(this, arguments);
    return _ref43;
  }
...
Diagrams.FlowChart.prototype.types.links.Flow = (function(_super) {
  ...
  function Flow() {
    _ref44 = Flow.__super__.constructor.apply(this, arguments);
    return _ref44;
  }
...
Diagrams.FlowChart.prototype.types.groups.Container = (function(_super) {
  ...
  function Container() {
    _ref45 = Container.__super__.constructor.apply(this, arguments);
    return _ref45;
  }
...
E.Box = (function(_super) {
  ...
  function Box() {
    _ref46 = Box.__super__.constructor.apply(this, arguments);
    return _ref46;
  }
...
E.Polygon = (function(_super) {
  ...
  function Polygon() {
    _ref47 = Polygon.__super__.constructor.apply(this, arguments);
    return _ref47;
  }
...
E.Ellipse = (function(_super) {
  ...
  function Ellipse() {
    _ref48 = Ellipse.__super__.constructor.apply(this, arguments);
    return _ref48;
  }
...
E.Oval = (function(_super) {
  ...
  function Oval() {
    _ref49 = Oval.__super__.constructor.apply(this, arguments);
    return _ref49;
  }
...
E.Circle = (function(_super) {
  ...
  function Circle() {
    _ref50 = Circle.__super__.constructor.apply(this, arguments);
    return _ref50;
  }
...
E.Triangle = (function(_super) {
  ...
  function Triangle() {
    _ref51 = Triangle.__super__.constructor.apply(this, arguments);
    return _ref51;
  }
...
E.Plaintext = (function(_super) {
  ...
  function Plaintext() {
    _ref52 = Plaintext.__super__.constructor.apply(this, arguments);
    return _ref52;
  }
...
E.Diamond = (function(_super) {
  ...
  function Diamond() {
    _ref53 = Diamond.__super__.constructor.apply(this, arguments);
    return _ref53;
  }
...
E.Trapezium = (function(_super) {
  ...
  function Trapezium() {
    _ref54 = Trapezium.__super__.constructor.apply(this, arguments);
    return _ref54;
  }
...
E.Parallelogram = (function(_super) {
  ...
  function Parallelogram() {
    _ref55 = Parallelogram.__super__.constructor.apply(this, arguments);
    return _ref55;
  }
...
E.House = (function(_super) {
  ...
  function House() {
    _ref56 = House.__super__.constructor.apply(this, arguments);
    return _ref56;
  }
...
E.Pentagon = (function(_super) {
  ...
  function Pentagon() {
    _ref57 = Pentagon.__super__.constructor.apply(this, arguments);
    return _ref57;
  }
...
E.Hexagon = (function(_super) {
  ...
  function Hexagon() {
    _ref58 = Hexagon.__super__.constructor.apply(this, arguments);
    return _ref58;
  }
...
E.Septagon = (function(_super) {
  ...
  function Septagon() {
    _ref59 = Septagon.__super__.constructor.apply(this, arguments);
    return _ref59;
  }
...
E.Octogon = (function(_super) {
  ...
  function Octogon() {
    _ref60 = Octogon.__super__.constructor.apply(this, arguments);
    return _ref60;
  }
...
E.Rect = (function(_super) {
  ...
  function Rect() {
    _ref61 = Rect.__super__.constructor.apply(this, arguments);
    return _ref61;
  }
...
E.Rectangle = (function(_super) {
  ...
  function Rectangle() {
    _ref62 = Rectangle.__super__.constructor.apply(this, arguments);
    return _ref62;
  }
...
E.Square = (function(_super) {
  ...
  function Square() {
    _ref63 = Square.__super__.constructor.apply(this, arguments);
    return _ref63;
  }
...
E.Star = (function(_super) {
  ...
  function Star() {
    _ref64 = Star.__super__.constructor.apply(this, arguments);
    return _ref64;
  }
...
E.None = (function(_super) {
  ...
  function None() {
    _ref65 = None.__super__.constructor.apply(this, arguments);
    return _ref65;
  }
...
E.Underline = (function(_super) {
  ...
  function Underline() {
    _ref66 = Underline.__super__.constructor.apply(this, arguments);
    return _ref66;
  }
...
E.Note = (function(_super) {
  ...
  function Note() {
    _ref67 = Note.__super__.constructor.apply(this, arguments);
    return _ref67;
  }
...
L.Link = (function(_super) {
  ...
  function Link() {
    _ref68 = Link.__super__.constructor.apply(this, arguments);
    return _ref68;
  }
...
Diagrams.UseCase.prototype.types.elements.Case = (function(_super) {
  ...
  function Case() {
    _ref69 = Case.__super__.constructor.apply(this, arguments);
    return _ref69;
  }
...
Diagrams.UseCase.prototype.types.groups.System = (function(_super) {
  ...
  function System() {
    _ref70 = System.__super__.constructor.apply(this, arguments);
    return _ref70;
  }
...
Diagrams.UseCase.prototype.types.links.Association = (function(_super) {
  ...
  function Association() {
    _ref71 = Association.__super__.constructor.apply(this, arguments);
    return _ref71;
  }
...
Diagrams.UseCase.prototype.types.links.Inheritance = (function(_super) {
  ...
  function Inheritance() {
    _ref72 = Inheritance.__super__.constructor.apply(this, arguments);
    return _ref72;
  }
...
Diagrams.UseCase.prototype.types.links.Aggregation = (function(_super) {
  ...
  function Aggregation() {
    _ref73 = Aggregation.__super__.constructor.apply(this, arguments);
    return _ref73;
  }
...
Diagrams.UseCase.prototype.types.links.Composition = (function(_super) {
  ...
  function Composition() {
    _ref74 = Composition.__super__.constructor.apply(this, arguments);
    return _ref74;
  }
...
Diagrams.UseCase.prototype.types.links.Comment = (function(_super) {
  ...
  function Comment() {
    _ref75 = Comment.__super__.constructor.apply(this, arguments);
    return _ref75;
  }
...
Electric = (function(_super) {
  ...
  function Electric() {
    _ref76 = Electric.__super__.constructor.apply(this, arguments);
    return _ref76;
  }
...
E.Resistor = (function(_super) {
  ...
  function Resistor() {
    _ref77 = Resistor.__super__.constructor.apply(this, arguments);
    return _ref77;
  }
...
E.Diode = (function(_super) {
  ...
  function Diode() {
    _ref78 = Diode.__super__.constructor.apply(this, arguments);
    return _ref78;
  }
...
E.Battery = (function(_super) {
  ...
  function Battery() {
    _ref79 = Battery.__super__.constructor.apply(this, arguments);
    return _ref79;
  }
...
E.PNPTransistor = (function(_super) {
  ...
  function PNPTransistor() {
    _ref80 = PNPTransistor.__super__.constructor.apply(this, arguments);
    return _ref80;
  }
...
E.NPNTransistor = (function(_super) {
  ...
  function NPNTransistor() {
    _ref81 = NPNTransistor.__super__.constructor.apply(this, arguments);
    return _ref81;
  }
...
Diagrams.Electric.prototype.types.links.Wire = (function(_super) {
  ...
  function Wire() {
    _ref82 = Wire.__super__.constructor.apply(this, arguments);
    return _ref82;
  }
...
Diagrams.Class.prototype.types.elements.Note = (function(_super) {
  ...
  function Note() {
    _ref83 = Note.__super__.constructor.apply(this, arguments);
    return _ref83;
  }
...
Diagrams.Class.prototype.types.elements.Class = (function(_super) {
  ...
  function Class() {
    _ref84 = Class.__super__.constructor.apply(this, arguments);
    return _ref84;
  }
...
Diagrams.Class.prototype.types.groups.System = (function(_super) {
  ...
  function System() {
    _ref85 = System.__super__.constructor.apply(this, arguments);
    return _ref85;
  }
...
L.Association = (function(_super) {
  ...
  function Association() {
    _ref86 = Association.__super__.constructor.apply(this, arguments);
    return _ref86;
  }
...
L.Inheritance = (function(_super) {
  ...
  function Inheritance() {
    _ref87 = Inheritance.__super__.constructor.apply(this, arguments);
    return _ref87;
  }
...
L.Aggregation = (function(_super) {
  ...
  function Aggregation() {
    _ref88 = Aggregation.__super__.constructor.apply(this, arguments);
    return _ref88;
  }
...
L.Composition = (function(_super) {
  ...
  function Composition() {
    _ref89 = Composition.__super__.constructor.apply(this, arguments);
    return _ref89;
  }
...
L.Comment = (function(_super) {
  ...
  function Comment() {
    _ref90 = Comment.__super__.constructor.apply(this, arguments);
    return _ref90;
  }
...
commands = {
  ...
  edit: {
    fun: function() {
      return edit((function() {
        ...
        var node, _i, _len, _ref91, _results;
        _ref91 = diagram.selection;
        _results = [];
        for (_i = 0, _len = _ref91.length; _i < _len; _i++) {
          node = _ref91[_i];
  ...
  remove: {
    fun: function() {
      var lnk, node, _i, _j, _len, _len1, _ref91, _ref92;
      _ref91 = diagram.selection;
      for (_i = 0, _len = _ref91.length; _i < _len; _i++) {
        node = _ref91[_i];
        ...
        _ref92 = diagram.links.slice();
        for (_j = 0, _len1 = _ref92.length; _j < _len1; _j++) {
          lnk = _ref92[_j];
  ...
  snaptogrid: {
    fun: function() {
      var node, _i, _len, _ref91;
      _ref91 = diagram.nodes();
      for (_i = 0, _len = _ref91.length; _i < _len; _i++) {
        node = _ref91[_i];
  ...
  "switch": {
    fun: function() {
      var link, node, _i, _j, _len, _len1, _ref91, _ref92, _ref93, _ref94;
      _ref91 = diagram.selection;
      for (_i = 0, _len = _ref91.length; _i < _len; _i++) {
        node = _ref91[_i];
        if (node instanceof Link) {
          _ref92 = [node.target, node.source], node.source = _ref92[0], node.target = _ref92[1];
        }
        if (node instanceof Element) {
          _ref93 = diagram.links;
          for (_j = 0, _len1 = _ref93.length; _j < _len1; _j++) {
            link = _ref93[_j];
            _ref94 = [link.target, link.source], link.source = _ref94[0], link.target = _ref94[1];
          }
        }
      }
      return svg.tick();
...
init_commands = function() {
  var cls, conf, e1, e2, element, first, fun, hotkey, i, icon, inc, key, link, margin, name, svgicon, taken_hotkeys, val, way, _ref91, _ref92, _ref93, _ref94, _results;
  _ref91 = diagram.force_conf;
  for (conf in _ref91) {
    val = _ref91[conf];
    _ref92 = {
      increase: 1.1,
  ...
  _ref93 = merge_copy(diagram.types.elements, diagram.types.groups);
  for (name in _ref93) {
    cls = _ref93[name];
    if (cls.alias) {
      continue;
...
edit = function(getter, setter) {
  ...
  textarea.on('input', function() {
    var val;
    setter(((function() {
      var _i, _len, _ref91, _results;
      _ref91 = this.value.split('\n');
      _results = [];
      for (_i = 0, _len = _ref91.length; _i < _len; _i++) {
        val = _ref91[_i];
        _results.push(val || ' ');
...
move_drag = d3.behavior.drag().origin(function(i) {
  ...
  var delta, nod, x, y, _i, _j, _len, _len1, _ref91, _ref92, _ref93;
  if (!diagram.dragging || d3.event.sourceEvent.ctrlKey) {
    return;
  }
  x = diagram.force ? 'px' : 'x';
  y = diagram.force ? 'py' : 'y';
  if (_ref91 = !node, __indexOf.call(diagram.selection, _ref91) >= 0) {
  ...
  var lnk, _i, _j, _len, _len1, _ref91, _ref92;
...
mouse_anchor = function(anchor) {
  ...
  return anchor.on("mousemove", function(anchor) {
    var lnk, node, _i, _len, _ref91, _results;
    if (d3.event.ctrlKey) {
      return;
    }
    d3.select(this).classed('active', true);
    node = d3.select($(this).closest('.node').get(0)).data()[0];
    _ref91 = diagram.linking;
    _results = [];
    for (_i = 0, _len = _ref91.length; _i < _len; _i++) {
      lnk = _ref91[_i];
    ...
    var lnk, _i, _len, _ref91, _results;
    if (d3.event.ctrlKey) {
      return;
    }
    ...
    var lnk, node, _i, _len, _ref91, _ref92;
    if (d3.event.ctrlKey) {
      return;
    }
    ...
    if (diagram.linking.length) {
      ...
      for (_i = 0, _len = _ref91.length; _i < _len; _i++) {
        lnk = _ref91[_i];
        if ((_ref92 = diagram.mouse) !== lnk.source && _ref92 !== lnk.target) {
...
write_text = function(txt, text) {
  var i, line, tspan, _i, _len, _ref91, _results;
  txt.selectAll('tspan').remove();
  _ref91 = text.split('\n');
  _results = [];
  for (i = _i = 0, _len = _ref91.length; _i < _len; i = ++_i) {
    line = _ref91[i];
...
enter_link = function(links, connect) {
  ...
  g.append("path").attr('class', function(link) {
    ...
    var _ref91;
    return "url(#" + (((_ref91 = link.marker_start) != null ? _ref91.id : void 0) || link.cls.marker_start.id) + ")";
  }).attr("marker-end", function(link) {
    var _ref91;
    return "url(#" + (((_ref91 = link.marker_end) != null ? _ref91.id : void 0) || link.cls.marker_end.id) + ")";
  });
...
update_link = function(links) {
  links.each(function(link) {
    var _ref91, _ref92;
    return d3.select(this).selectAll('path').attr('d', link.path()).attr("marker-start", "url(#" + (((_ref92 = link.marker_start) != null ? _ref92.id : void 0) || link.cls.marker_start.id) + ")").attr("marker-end", "url(#" + (((_ref91 = link.marker_end) != null ? _ref91.id : void 0) || link.cls.marker_end.id) + ")");
  });
  links.each(function(link) {
    var g, txt;
    g = d3.select(this);
...
Svg = (function(_super) {
  ...
  function Svg() {
    ...
    this.zoom = zoom.scale(diagram.zoom.scale).translate(diagram.zoom.translate).scaleExtent([.05, 5]).on("zoom", function() {
      var _ref91;
      if (((_ref91 = d3.event.sourceEvent.type) === 'wheel' || _ref91 === 'click') || d3.event.sourceEvent.ctrlKey || d3.event.sourceEvent.which === 2) {
...
list_local = function() {
  var $tbody, $tr, b64_diagram, key, title, type, _ref91;
  ...
  return remoteStorage.getItem('umlaut_key_list', function(list) {
    ...
    for (_i = 0, _len = list.length; _i < _len; _i++) {
      ...
      _results.push(remoteStorage.getItem(key, function(b64_diagram, key_) {
        var $tr, title, type, _ref91;
        _ref91 = key_.slice(7).split('-_-'), type = _ref91[0], title = _ref91[1];
        if (title == null) {
          return;
        }
        $tbody.append($tr = $('<tr>'));
...
Keyword = (function(_super) {
  ...
  function Keyword() {
    _ref91 = Keyword.__super__.constructor.apply(this, arguments);
    return _ref91;
  }
...
Id = (function(_super) {
  ...
  function Id() {
    _ref92 = Id.__super__.constructor.apply(this, arguments);
    return _ref92;
  }
...
Number = (function(_super) {
  ...
  function Number() {
    _ref93 = Number.__super__.constructor.apply(this, arguments);
    return _ref93;
  }
...
QuotedId = (function(_super) {
  ...
  function QuotedId() {
    _ref94 = QuotedId.__super__.constructor.apply(this, arguments);
    return _ref94;
  }
...
Brace = (function(_super) {
  ...
  function Brace() {
    _ref95 = Brace.__super__.constructor.apply(this, arguments);
    return _ref95;
  }
...
Delimiter = (function(_super) {
  ...
  function Delimiter() {
    _ref96 = Delimiter.__super__.constructor.apply(this, arguments);
    return _ref96;
  }
...
Assign = (function(_super) {
  ...
  function Assign() {
    _ref97 = Assign.__super__.constructor.apply(this, arguments);
    return _ref97;
  }
...
Operator = (function(_super) {
  ...
  function Operator() {
    _ref98 = Operator.__super__.constructor.apply(this, arguments);
    return _ref98;
  }
...
dot_tokenize = function(s) {
  var chr, col, escape, id, last_chr, len, op, pos, row, token, tokens, _ref100, _ref99;
  pos = 0;
  row = 0;
  col = 0;
  len = s.length;
  ...
  while (pos < len) {
    ...
    if (chr.match(RE_SPACE)) {
      ...
      id = chr;
      while ((_ref99 = (chr = s[pos++])) != null ? _ref99.match(RE_ALPHADIGIT) : void 0) {
        id += chr;
      }
      pos--;
      ...
      id = chr;
      while ((_ref100 = (chr = s[pos++])) != null ? _ref100.match(RE_DIGIT) : void 0) {
        id += chr;
      }
      pos--;
...
Statement = (function() {
  ...
  Statement.prototype.get_attrs = function() {
    var attribute, attrs, _i, _len, _ref99;
    attrs = {};
    _ref99 = this.attributes;
    for (_i = 0, _len = _ref99.length; _i < _len; _i++) {
      attribute = _ref99[_i];
...
dot_lex = function(tokens) {
  ...
  parse_node = function() {
    var compass_pt, node, port, _ref99;
    if (tokens[pos] instanceof Keyword && tokens[pos].value === 'subgraph') {
      node = parse_subgraph();
      ...
      if (tokens[pos + 1] instanceof Delimiter && tokens[pos + 1].value === ':') {
        ...
        if (tokens[pos + 1] instanceof Delimiter && tokens[pos + 1].value === ':') {
          pos += 2;
          if (!(tokens[pos] instanceof Id) || (_ref99 = tokens[pos].value, __indexOf.call(COMPASS_PTS, _ref99) < 0)) {
  ...
  parse_statement = function() {
    var left, statement, _ref99;
    if (tokens[pos] instanceof Brace && tokens[pos].value === '}') {
      return null;
    }
    if (tokens[pos] instanceof Keyword && tokens[pos].value !== 'subgraph') {
      if ((_ref99 = tokens[pos].value) !== 'graph' && _ref99 !== 'node' && _ref99 !== 'edge') {
  ...
  populate = function(statements) {
    ...
    for (_i = 0, _len = statements.length; _i < _len; _i++) {
      ...
      _results.push((function() {
        var _j, _len1, _ref99, _results1;
        _ref99 = statement.nodes;
        _results1 = [];
        for (i = _j = 0, _len1 = _ref99.length; _j < _len1; i = ++_j) {
          node = _ref99[i];
          ...
          if (i !== 0) {
            ...
            if (prev_node instanceof SubGraph) {
              _results1.push((function() {
                var _k, _len2, _ref100, _results2;
                _ref100 = prev_node.statements;
                _results2 = [];
                for (_k = 0, _len2 = _ref100.length; _k < _len2; _k++) {
                  sub_prev_statement = _ref100[_k];
                  _results2.push((function() {
                    var _l, _len3, _ref101, _results3;
                    _ref101 = sub_prev_statement.nodes;
                    _results3 = [];
                    for (_l = 0, _len3 = _ref101.length; _l < _len3; _l++) {
                      sub_prev_node = _ref101[_l];
                      if (node instanceof SubGraph) {
                        _results3.push((function() {
                          var _len4, _m, _ref102, _results4;
                          _ref102 = node.statements;
                          _results4 = [];
                          for (_m = 0, _len4 = _ref102.length; _m < _len4; _m++) {
                            sub_statement = _ref102[_m];
                            _results4.push((function() {
                              var _len5, _n, _ref103, _results5;
                              _ref103 = sub_statement.nodes;
                              _results5 = [];
                              for (_n = 0, _len5 = _ref103.length; _n < _len5; _n++) {
                                sub_node = _ref103[_n];
              ...
              if (node instanceof SubGraph) {
                _results1.push((function() {
                  var _k, _len2, _ref100, _results2;
                  _ref100 = node.statements;
                  _results2 = [];
                  for (_k = 0, _len2 = _ref100.length; _k < _len2; _k++) {
                    sub_statement = _ref100[_k];
                    _results2.push((function() {
                      var _l, _len3, _ref101, _results3;
                      _ref101 = sub_statement.nodes;
                      _results3 = [];
                      for (_l = 0, _len3 = _ref101.length; _l < _len3; _l++) {
                        sub_node = _ref101[_l];
                        _results3.push(links_by_id.push({
