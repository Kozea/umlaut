...
var Actor, Arrow, Association, Case, DataIO, Decision, Delay, Diagram, Element, FlowChart, Link, Mouse, Process, Svg, Terminator, UseCase, commands, dist, edit, element_add, generate_url, history_pop, init_commands, list_diagrams, load, mouse_xy, save, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8,
...
Svg = (function() {
  function Svg() {
    ...
    this.drag = this.force.drag().on("drag.force", function(elt) {
      ...
      if (_ref9 = !elt, __indexOf.call(diagram.selection, _ref9) >= 0) {
