...
var Actor, Aggregation, Arrow, Association, Base, Battery, BlackArrow, Case, Class, ClassDiagram, Comment, Composition, Container, Database, Decision, Delay, Diagram, Diamond, Diode, Document, Electric, ElectricDiagram, Element, Ellipsis, Flow, FlowChart, Group, HardDisk, IO, Inheritance, InternalStorage, Link, Lozenge, ManualInput, Marker, Mouse, Node, Note, Preparation, Process, Rect, Resistor, ShapeDiagram, SubProcess, Svg, System, Terminator, UseCase, Void, WhiteArrow, WhiteDiamond, Wire, anchor_link_drag, commands, dist, edit, ellipsis, enter_link, enter_node, force_drag, generate_url, history_pop, init_commands, list_diagrams, load, lozenge, mouse_anchor, mouse_link, mouse_node, mouse_xy, node_add, note, nsweo_resize_drag, rectangle, save, tick_link, tick_node, uml_elements, uml_links, update_link, update_node, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref25, _ref26, _ref27, _ref28, _ref29, _ref3, _ref30, _ref31, _ref32, _ref33, _ref34, _ref35, _ref36, _ref37, _ref38, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
...
Element = (function(_super) {
  ...
  Element.prototype.rotate = function(pos) {
    var rad, x, y;
    rad = Math.PI * this._rotation / 180;
    x = pos.x - this.x;
    y = pos.y - this.y;
    return {
...
Diagram = (function(_super) {
  ...
  Diagram.prototype.loads = function(obj) {
    var element, element_type, elt, group, group_type, grp, link, link_type, lnk, _i, _j, _k, _len, _len1, _len2, _ref4, _ref5, _ref6, _results;
    if (obj.title) {
...
rectangle = (function(_super) {
  ...
  function rectangle() {
    _ref17 = rectangle.__super__.constructor.apply(this, arguments);
    return _ref17;
  }
...
note = (function(_super) {
  ...
  function note() {
    _ref20 = note.__super__.constructor.apply(this, arguments);
    return _ref20;
  }
...
ShapeDiagram = (function(_super) {
  __extends(ShapeDiagram, _super);

  ShapeDiagram.prototype.label = ' Shapes Diagram';

  function ShapeDiagram() {
    ShapeDiagram.__super__.constructor.apply(this, arguments);
    this.types = {
...
Process = (function(_super) {
  ...
  function Process() {
    _ref21 = Process.__super__.constructor.apply(this, arguments);
    return _ref21;
  }
...
Terminator = (function(_super) {
  ...
  function Terminator() {
    _ref22 = Terminator.__super__.constructor.apply(this, arguments);
    return _ref22;
  }
...
SubProcess = (function(_super) {
  ...
  function SubProcess() {
    _ref23 = SubProcess.__super__.constructor.apply(this, arguments);
    return _ref23;
  }
...
Document = (function(_super) {
  ...
  function Document() {
    _ref24 = Document.__super__.constructor.apply(this, arguments);
    return _ref24;
  }
...
Database = (function(_super) {
  ...
  function Database() {
    _ref25 = Database.__super__.constructor.apply(this, arguments);
    return _ref25;
  }
...
HardDisk = (function(_super) {
  ...
  function HardDisk() {
    _ref26 = HardDisk.__super__.constructor.apply(this, arguments);
    return _ref26;
  }
...
Preparation = (function(_super) {
  ...
  function Preparation() {
    _ref27 = Preparation.__super__.constructor.apply(this, arguments);
    return _ref27;
  }
...
InternalStorage = (function(_super) {
  ...
  function InternalStorage() {
    _ref28 = InternalStorage.__super__.constructor.apply(this, arguments);
    return _ref28;
  }
...
Flow = (function(_super) {
  ...
  function Flow() {
    _ref29 = Flow.__super__.constructor.apply(this, arguments);
    return _ref29;
  }
...
Container = (function(_super) {
  ...
  function Container() {
    _ref30 = Container.__super__.constructor.apply(this, arguments);
    return _ref30;
  }
...
Case = (function(_super) {
  ...
  function Case() {
    _ref31 = Case.__super__.constructor.apply(this, arguments);
    return _ref31;
  }
...
System = (function(_super) {
  ...
  function System() {
    _ref32 = System.__super__.constructor.apply(this, arguments);
    return _ref32;
  }
...
Electric = (function(_super) {
  ...
  function Electric() {
    _ref33 = Electric.__super__.constructor.apply(this, arguments);
    return _ref33;
  }
  ...
  Electric.prototype.direction = function(x, y) {
    var _ref34;
    if (this._rotation < 45 || (135 < (_ref34 = this._rotation) && _ref34 < 225) || this._rotation > 315) {
      if (x > this.x) {
        return 'E';
      }
      return 'W';
...
Node = (function(_super) {
  ...
  Node.prototype.base_width = function() {
    return Node.__super__.base_width.call(this) / 4;
  };
...
Resistor = (function(_super) {
  ...
  function Resistor() {
    _ref34 = Resistor.__super__.constructor.apply(this, arguments);
    return _ref34;
  }
...
Diode = (function(_super) {
  ...
  function Diode() {
    _ref35 = Diode.__super__.constructor.apply(this, arguments);
    return _ref35;
  }
...
Battery = (function(_super) {
  ...
  function Battery() {
    _ref36 = Battery.__super__.constructor.apply(this, arguments);
    return _ref36;
  }

  Battery.fill = 'fg';

  Battery.prototype.base_width = function() {
    return Battery.__super__.base_width.call(this) / 3;
  };
  ...
  Battery.prototype.path = function() {
    ...
    h2 = this.height() / 2;
    h4 = h2 / 2;
    return "M " + (-w2) + " " + (-h4) + "         L " + (-w4) + " " + (-h4) + "         L " + (-w4) + " " + h4 + "         L " + (-w2) + " " + h4 + "         z         M " + w2 + " " + (-h2) + "         L " + w2 + " " + h2 + "        ";
  };
...
Wire = (function(_super) {
  ...
  function Wire() {
    _ref37 = Wire.__super__.constructor.apply(this, arguments);
    return _ref37;
  }
  ...
  Wire.prototype.path = function() {
    ...
    if (c2.x > c1.x || c2.y > c1.y && !(c2.x > c1.x && c2.y > c1.y)) {
      path = "" + path + " " + this.a1.x + " " + this.a2.y + " L";
    } else {
      path = "" + path + " " + this.a2.x + " " + this.a1.y + " L";
    }
...
Class = (function(_super) {
  ...
  function Class() {
    _ref38 = Class.__super__.constructor.apply(this, arguments);
    return _ref38;
  }
...
node_add = function(type) {
  ...
  new_node = new type(x, y, "" + type.name + " #" + nth, !diagram.freemode);
  set.push(new_node);
  if (d3.event) {
  ...
  if (d3.event) {
    dom_node = null;
    svg.svg.selectAll('g.element,g.group').each(function(node) {
      if (node === new_node) {
...
commands = {
  ...
  edit: {
    fun: function() {
      edit((function() {
        ...
        var node, _i, _len, _ref39, _results;
        _ref39 = diagram.selection;
        _results = [];
  ...
  remove: {
    fun: function() {
      var lnk, node, _i, _j, _len, _len1, _ref39, _ref40;
      _ref39 = diagram.selection;
      for (_i = 0, _len = _ref39.length; _i < _len; _i++) {
        node = _ref39[_i];
  ...
  freemode: {
    fun: function() {
      var node, _i, _len, _ref39;
      _ref39 = diagram.nodes();
      for (_i = 0, _len = _ref39.length; _i < _len; _i++) {
        node = _ref39[_i];
  ...
  "switch": {
    fun: function() {
      var link, node, _i, _j, _len, _len1, _ref39, _ref40, _ref41, _ref42;
      _ref39 = diagram.selection;
      for (_i = 0, _len = _ref39.length; _i < _len; _i++) {
        node = _ref39[_i];
        if (node instanceof Link) {
          _ref40 = [node.target, node.source], node.source = _ref40[0], node.target = _ref40[1];
        }
        if (node instanceof Element) {
          _ref41 = diagram.links;
          for (_j = 0, _len1 = _ref41.length; _j < _len1; _j++) {
            link = _ref41[_j];
            _ref42 = [link.target, link.source], link.source = _ref42[0], link.target = _ref42[1];
          }
        }
      }
      return svg.tick();
...
init_commands = function() {
  var e, e1, e2, element, fun, hotkey, i, icon, key, l, link, margin, n, svgicon, taken_hotkeys, _i, _j, _len, _len1, _ref39, _ref40, _results;
  taken_hotkeys = [];
  ...
  _ref39 = diagram.types.elements.concat(diagram.types.groups);
  for (_i = 0, _len = _ref39.length; _i < _len; _i++) {
    e = _ref39[_i];
    i = 1;
  ...
  taken_hotkeys = [];
  _ref40 = diagram.types.links;
  _results = [];
  for (n = _j = 0, _len1 = _ref40.length; _j < _len1; n = ++_j) {
    l = _ref40[n];
    i = 1;
...
force_drag = function(force) {
  return force.on('dragstart', function(node) {
  ...
  }).on("drag.force", function(node) {
    var delta, _i, _len, _ref39, _ref40;
    if (!diagram.dragging || d3.event.sourceEvent.ctrlKey) {
      return;
    }
    if (_ref39 = !node, __indexOf.call(diagram.selection, _ref39) >= 0) {
...
nsweo_resize_drag = d3.behavior.drag().on("dragstart", function(handle) {
  ...
  node = d3.select($(this).closest('.element,.group').get(0)).data()[0];
  ...
  var angle, delta, m, node, nodes, signs;
  if (d3.event.ctrlKey) {
    return;
  }
  nodes = d3.select($(this).closest('.element,.group').get(0));
  node = nodes.data()[0];
...
anchor_link_drag = d3.behavior.drag().on("dragstart", function(anchor) {
  ...
  diagram.linking = [];
  svg.sync();
  return diagram.linking = [];
});

mouse_anchor = function(anchor) {
  var _this = this;
  return anchor.on("mousemove", function(anchor) {
    var lnk, node, _i, _len, _ref39, _results;
    if (d3.event.ctrlKey) {
      return;
    }
    d3.select(this).classed('active', true);
    node = d3.select($(this).closest('.element,.group').get(0)).data()[0];
    _ref39 = diagram.linking;
    _results = [];
    for (_i = 0, _len = _ref39.length; _i < _len; _i++) {
      lnk = _ref39[_i];
    ...
    var lnk, _i, _len, _ref39, _results;
    if (d3.event.ctrlKey) {
      return;
    }
    ...
    var link, lnk, node, _i, _len, _ref39;
    if (d3.event.ctrlKey) {
      return;
    }
    node = d3.select($(_this).closest('.element,.group').get(0)).data()[0];
...
update_node = function(nodes) {
  nodes.select('text').each(function(node) {
    var i, line, tspan, txt, _i, _len, _ref39, _results;
    txt = d3.select(this);
    if (node.text === txt.text) {
      return;
    }
    txt.selectAll('tspan').remove();
    _ref39 = node.text.split('\n');
    _results = [];
    for (i = _i = 0, _len = _ref39.length; _i < _len; i = ++_i) {
      line = _ref39[i];
  ...
  nodes.select('.shape').attr('d', function(node) {
    return node.path();
  });
...
tick_node = function(nodes) {
  return nodes.attr("transform", (function(node) {
    return "translate(" + node.x + "," + node.y + ")rotate(" + node._rotation + ")";
  })).classed('moving', function(node) {
    return !node.fixed;
    ...
    d3.select(this).selectAll('.handle').data(node.handle_list()).attr('d', function(handle) {
      ...
      if (handle !== 'O') {
        return "M " + (h.x - s) + " " + (h.y - s) + "                         L " + (h.x + s) + " " + (h.y - s) + "                         L " + (h.x + s) + " " + (h.y + s) + "                         L " + (h.x - s) + " " + (h.y + s) + "                        z";
      } else {
        return "M " + h.x + " " + h.y + "                         L " + h.x + " " + (h.y - 2 * s) + "                         A " + s + " " + s + " 0 1 1 " + h.x + " " + (h.y - 4 * s) + "                         A " + s + " " + s + " 0 1 1 " + h.x + " " + (h.y - 2 * s) + "                        ";
      }
    });
    s = 10;
    return d3.select(this).selectAll('.anchor').data(node.anchor_list()).attr('d', function(anchor) {
      var a;
      a = node.anchors[anchor]();
      a.x -= node.x;
      a.y -= node.y;
      return "M " + a.x + " " + (a.y + s) + "                     A " + s + " " + s + " 0 1 1 " + a.x + " " + (a.y - s) + "                     A " + s + " " + s + " 0 1 1 " + a.x + " " + (a.y + s);
    });
  });
};
...
tick_link = function(links) {
  ...
  links.select('text.start').attr('transform', function(link) {
    return "translate(" + link.a1.x + ", " + link.a1.y + ")";
  }).attr('dx', function(link) {
    var _ref39;
    if ((_ref39 = link.d1) === 'N' || _ref39 === 'E') {
      return link.text_margin + this.getBBox().width / 2;
    } else {
      return -(link.text_margin + this.getBBox().width / 2);
    }
    ...
    var _ref39;
    if ((_ref39 = link.d1) === 'N' || _ref39 === 'E') {
      return -(this.getBBox().height + link.text_margin);
    } else {
      return link.text_margin;
    }
  });
  return links.select('text.end').attr('transform', function(link) {
    return "translate(" + link.a2.x + ", " + link.a2.y + ")";
  }).attr('dx', function(link) {
    var _ref39;
    if ((_ref39 = link.d2) === 'N' || _ref39 === 'E') {
      return link.text_margin + this.getBBox().width / 2;
    } else {
      return -(link.text_margin + this.getBBox().width / 2);
    }
...
Svg = (function(_super) {
  ...
  function Svg() {
    ...
    this.zoom = d3.behavior.zoom().scale(diagram.zoom.scale).translate(diagram.zoom.translate).scaleExtent([.15, 5]).on("zoom", function() {
      var _ref39;
      if (!d3.event.sourceEvent || ((_ref39 = d3.event.sourceEvent.type) === 'wheel' || _ref39 === 'click') || d3.event.sourceEvent.ctrlKey || d3.event.sourceEvent.which === 2) {
  ...
  Svg.prototype.tick = function() {
    var elt, need_force, _i, _len, _ref39;
    need_force = false;
    _ref39 = diagram.nodes();
    for (_i = 0, _len = _ref39.length; _i < _len; _i++) {
      elt = _ref39[_i];
...
list_diagrams = function() {
  var $tbody, $tr, $ul, b64_diagram, diagram, key, name, title, type, _ref39, _ref40, _results;
  $tbody = $('#diagrams tbody');
  $tbody.find('.local').remove();
  for (key in localStorage) {
    b64_diagram = localStorage[key];
    _ref39 = key.split('|'), type = _ref39[0], title = _ref39[1];
    if (title == null) {
      continue;
    }
    $tbody.append($tr = $('<tr>'));
