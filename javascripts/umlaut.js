...
Battery = (function(_super) {
  ...
  Battery.prototype.base_width = function() {
    return Battery.__super__.base_width.call(this) / 2;
  };
  ...
  Battery.prototype.path = function() {
    ...
    h2 = this.height() / 2;
    h4 = h2 / 2;
    return "M " + (-w2) + " " + (-h4) + "         L 0 " + (-h4) + "         L 0 " + h4 + "         L " + (-w2) + " " + h4 + "         z         M " + w2 + " " + (-h2) + "         L " + w2 + " " + h2 + "        ";
  };
...
init_commands = function() {
  var e, e1, e2, fun, g, hotkey, i, icon, key, l, margin, path, svgicon, taken_hotkeys, txt, _i, _j, _len, _len1, _ref35, _ref36, _results;
  taken_hotkeys = [];
...
Svg = (function() {
  ...
  Svg.prototype.sync = function() {
    ...
    force_drag = this.force.drag().on("drag.force", function(elt) {
      ...
      if (_ref35 = !elt, __indexOf.call(diagram.selection, _ref35) >= 0) {
  ...
  Svg.prototype.tick = function() {
    var elt, link, need_force, _i, _len, _ref35;
    need_force = false;
    _ref35 = diagram.nodes();
    for (_i = 0, _len = _ref35.length; _i < _len; _i++) {
      elt = _ref35[_i];
