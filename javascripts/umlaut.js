...
var Actor, Association, Case, Decision, Delay, Diagram, Document, Element, Ellipsis, Flow, FlowChart, IO, Inheritance, Link, Lozenge, Mouse, Process, Rect, SubProcess, Svg, Terminator, UseCase, commands, dist, edit, element_add, generate_url, history_pop, init_commands, link_add, list_diagrams, load, mouse_xy, save, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
...
Flow = (function(_super) {
  ...
  function Flow() {
    _ref11 = Flow.__super__.constructor.apply(this, arguments);
    return _ref11;
  }
...
Case = (function(_super) {
  ...
  function Case() {
    _ref12 = Case.__super__.constructor.apply(this, arguments);
    return _ref12;
  }
...
Actor = (function(_super) {
  ...
  function Actor() {
    _ref13 = Actor.__super__.constructor.apply(this, arguments);
    return _ref13;
  }
...
Association = (function(_super) {
  ...
  function Association() {
    _ref14 = Association.__super__.constructor.apply(this, arguments);
    return _ref14;
  }
...
Inheritance = (function(_super) {
  ...
  function Inheritance() {
    _ref15 = Inheritance.__super__.constructor.apply(this, arguments);
    return _ref15;
  }
...
link_add = function(type) {
  var elt, _i, _len, _ref16;
  diagram.linking = [];
  _ref16 = diagram.selection;
...
commands = {
  ...
  edit: {
    fun: function() {
      edit((function() {
        ...
        var elt, _i, _len, _ref16, _results;
        _ref16 = diagram.selection;
        _results = [];
        for (_i = 0, _len = _ref16.length; _i < _len; _i++) {
          elt = _ref16[_i];
  ...
  remove: {
    fun: function() {
      var elt, lnk, _i, _j, _len, _len1, _ref16, _ref17;
      _ref16 = diagram.selection;
      for (_i = 0, _len = _ref16.length; _i < _len; _i++) {
        elt = _ref16[_i];
...
init_commands = function() {
  var e, e1, e2, fun, g, hotkey, i, icon, key, l, margin, path, svgicon, taken_hotkeys, txt, _i, _j, _len, _len1, _ref16, _ref17, _results;
  taken_hotkeys = [];
...
Svg = (function() {
  function Svg() {
    ...
    this.drag = this.force.drag().on("drag.force", function(elt) {
      var delta, _i, _len, _ref16, _ref17;
      if (!diagram.dragging || d3.event.sourceEvent.ctrlKey) {
        return;
      }
      if (_ref16 = !elt, __indexOf.call(diagram.selection, _ref16) >= 0) {
    ...
    this.zoom = d3.behavior.zoom().scale(diagram.zoom.scale).translate(diagram.zoom.translate).scaleExtent([.15, 5]).on("zoom", function() {
      var _ref16;
      if (!d3.event.sourceEvent || ((_ref16 = d3.event.sourceEvent.type) === 'wheel' || _ref16 === 'click') || d3.event.sourceEvent.ctrlKey || d3.event.sourceEvent.which === 2) {
  ...
  Svg.prototype.sync = function() {
    ...
    element_g = this.element.enter().append('g').attr('class', 'element').call(this.drag).on("mousedown", function(elt) {
      ...
      var lnk, _i, _len, _ref16, _results;
      if (d3.event.ctrlKey) {
        return;
      }
      _ref16 = diagram.linking;
      _results = [];
      for (_i = 0, _len = _ref16.length; _i < _len; _i++) {
        lnk = _ref16[_i];
    ...
    this.element.select('text').each(function(elt) {
      var i, line, tspan, txt, _i, _len, _ref16, _results;
      txt = d3.select(this);
      if (elt.text === txt.text) {
        return;
      }
      txt.selectAll('tspan').remove();
      _ref16 = elt.text.split('\n');
      _results = [];
  ...
  Svg.prototype.tick = function() {
    var elt, need_force, _i, _len, _ref16;
    need_force = false;
    _ref16 = diagram.elements;
    for (_i = 0, _len = _ref16.length; _i < _len; _i++) {
      elt = _ref16[_i];
...
list_diagrams = function() {
  var $tbody, $tr, $ul, b64_diagram, diagram, key, name, title, type, _ref16, _ref17, _results;
  $tbody = $('#diagrams tbody');
  $tbody.find('.local').remove();
  for (key in localStorage) {
    b64_diagram = localStorage[key];
    _ref16 = key.split('|'), type = _ref16[0], title = _ref16[1];
    if (title == null) {
      continue;
    }
    $tbody.append($tr = $('<tr>'));
