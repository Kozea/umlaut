...
var Actor, Aggregation, Arrow, Association, BlackArrow, Case, Class, ClassDiagram, Comment, Composition, Container, Database, Decision, Delay, Diagram, Diamond, Document, Element, Ellipsis, Flow, FlowChart, Group, HardDisk, IO, Inheritance, InternalStorage, Link, Lozenge, ManualInput, Marker, Mouse, Note, Preparation, Process, Rect, SubProcess, Svg, System, Terminator, UseCase, Void, WhiteArrow, WhiteDiamond, commands, dist, edit, element_add, generate_url, history_pop, init_commands, link_add, list_diagrams, load, mouse_xy, save, uml_elements, uml_links, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref25, _ref26, _ref27, _ref28, _ref29, _ref3, _ref30, _ref31, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
...
Diagram = (function() {
  ...
  Diagram.prototype.loads = function(obj) {
    var element, elt, group, group_type, grp, link, lnk, _i, _j, _k, _len, _len1, _len2, _ref4, _ref5, _ref6, _results;
    if (obj.title) {
...
Note = (function(_super) {
  ...
  Note.prototype.width = function() {
    return Note.__super__.width.call(this) + this.shift;
  };

  Note.prototype.height = function() {
    return Note.__super__.height.call(this);
  };
...
Group = (function(_super) {
  ...
  Group.prototype.height = function() {
    return Math.max(this._height, Group.__super__.height.call(this));
  };

  Group.prototype.width = function() {
    return Math.max(this._width, Group.__super__.width.call(this));
  };
...
Delay = (function(_super) {
  ...
  function Delay() {
    _ref19 = Delay.__super__.constructor.apply(this, arguments);
    return _ref19;
  }
...
SubProcess = (function(_super) {
  ...
  function SubProcess() {
    _ref20 = SubProcess.__super__.constructor.apply(this, arguments);
    return _ref20;
  }
...
Document = (function(_super) {
  ...
  function Document() {
    _ref21 = Document.__super__.constructor.apply(this, arguments);
    return _ref21;
  }
...
Database = (function(_super) {
  ...
  function Database() {
    _ref22 = Database.__super__.constructor.apply(this, arguments);
    return _ref22;
  }
...
HardDisk = (function(_super) {
  ...
  function HardDisk() {
    _ref23 = HardDisk.__super__.constructor.apply(this, arguments);
    return _ref23;
  }
...
Preparation = (function(_super) {
  ...
  function Preparation() {
    _ref24 = Preparation.__super__.constructor.apply(this, arguments);
    return _ref24;
  }
...
InternalStorage = (function(_super) {
  ...
  function InternalStorage() {
    _ref25 = InternalStorage.__super__.constructor.apply(this, arguments);
    return _ref25;
  }
...
Flow = (function(_super) {
  ...
  function Flow() {
    _ref26 = Flow.__super__.constructor.apply(this, arguments);
    return _ref26;
  }

  Flow.marker = new Arrow();
...
Container = (function(_super) {
  ...
  function Container() {
    _ref27 = Container.__super__.constructor.apply(this, arguments);
    return _ref27;
  }
...
Case = (function(_super) {
  ...
  function Case() {
    _ref28 = Case.__super__.constructor.apply(this, arguments);
    return _ref28;
  }
...
Actor = (function(_super) {
  ...
  function Actor() {
    _ref29 = Actor.__super__.constructor.apply(this, arguments);
    return _ref29;
  }
...
System = (function(_super) {
  ...
  function System() {
    _ref30 = System.__super__.constructor.apply(this, arguments);
    return _ref30;
  }
...
Class = (function(_super) {
  ...
  function Class() {
    _ref31 = Class.__super__.constructor.apply(this, arguments);
    return _ref31;
  }
...
link_add = function(type) {
  var elt, _i, _len, _ref32;
  diagram.linking = [];
  _ref32 = diagram.selection;
...
commands = {
  ...
  edit: {
    fun: function() {
      edit((function() {
        ...
        var elt, _i, _len, _ref32, _results;
        _ref32 = diagram.selection;
        _results = [];
        for (_i = 0, _len = _ref32.length; _i < _len; _i++) {
          elt = _ref32[_i];
  ...
  remove: {
    fun: function() {
      var elt, lnk, _i, _j, _len, _len1, _ref32, _ref33;
      _ref32 = diagram.selection;
      for (_i = 0, _len = _ref32.length; _i < _len; _i++) {
        elt = _ref32[_i];
  ...
  "switch": {
    fun: function() {
      var node, _i, _len, _ref32, _ref33;
      _ref32 = diagram.selection;
      for (_i = 0, _len = _ref32.length; _i < _len; _i++) {
        node = _ref32[_i];
        if (node instanceof Link) {
          _ref33 = [node.target, node.source], node.source = _ref33[0], node.target = _ref33[1];
        }
      }
      return svg.tick();
    },
...
init_commands = function() {
  var e, e1, e2, fun, g, hotkey, i, icon, key, l, margin, path, svgicon, taken_hotkeys, txt, _i, _j, _len, _len1, _ref32, _ref33, _results;
  taken_hotkeys = [];
  ...
  _ref32 = diagram.types.elements.concat(diagram.types.groups);
  for (_i = 0, _len = _ref32.length; _i < _len; _i++) {
    e = _ref32[_i];
    i = 1;
  ...
  for (_j = 0, _len1 = _ref33.length; _j < _len1; _j++) {
    ...
    path = svgicon.append('path').attr("class", "shape").attr("marker-end", "url(#" + icon.constructor.marker.id + ")").attr('d', icon.path());
...
Svg = (function() {
  function Svg() {
    ...
    this.zoom = d3.behavior.zoom().scale(diagram.zoom.scale).translate(diagram.zoom.translate).scaleExtent([.15, 5]).on("zoom", function() {
      var _ref32;
      if (!d3.event.sourceEvent || ((_ref32 = d3.event.sourceEvent.type) === 'wheel' || _ref32 === 'click') || d3.event.sourceEvent.ctrlKey || d3.event.sourceEvent.which === 2) {
  ...
  Svg.prototype.sync = function() {
    ...
    force_drag = this.force.drag().on("drag.force", function(elt) {
      var delta, _i, _len, _ref32, _ref33;
      if (!diagram.dragging || d3.event.sourceEvent.ctrlKey) {
        return;
      }
      if (_ref32 = !elt, __indexOf.call(diagram.selection, _ref32) >= 0) {
    ...
    group_g = group.enter().append('g').attr("class", "group").call(force_drag).on("mousedown", function(grp) {
      ...
      var lnk, _i, _len, _ref32, _results;
      if (d3.event.ctrlKey) {
        return;
      }
      _ref32 = diagram.linking;
      _results = [];
      for (_i = 0, _len = _ref32.length; _i < _len; _i++) {
        lnk = _ref32[_i];
    ...
    resize_drag = d3.behavior.drag().on("dragstart", function(grp) {
      return d3.event.sourceEvent.stopPropagation();
    }).on("drag", function(grp) {
      grp._width += d3.event.dx * 2;
      grp._height += d3.event.dy * 2;
      group = d3.select(this.parentNode);
      group.selectAll('path').attr('d', grp.path());
      group.select('text').attr('x', grp.txt_x()).attr('y', grp.txt_y()).selectAll('tspan').attr('x', grp.txt_x());
      return svg.tick();
    }).on("dragend", function(grp) {
    ...
    group.select('text').each(function(elt) {
      var i, line, tspan, txt, _i, _len, _ref32, _results;
      txt = d3.select(this);
      if (elt.text === txt.text) {
        return;
      }
      txt.selectAll('tspan').remove();
      _ref32 = elt.text.split('\n');
      _results = [];
    ...
    element_g.append('path').attr('class', 'ghost');
  ...
  Svg.prototype.tick = function() {
    var elt, link, need_force, _i, _len, _ref32;
    need_force = false;
    _ref32 = diagram.nodes();
    for (_i = 0, _len = _ref32.length; _i < _len; _i++) {
      elt = _ref32[_i];
...
list_diagrams = function() {
  var $tbody, $tr, $ul, b64_diagram, diagram, key, name, title, type, _ref32, _ref33, _results;
  $tbody = $('#diagrams tbody');
  $tbody.find('.local').remove();
  for (key in localStorage) {
    b64_diagram = localStorage[key];
    _ref32 = key.split('|'), type = _ref32[0], title = _ref32[1];
    if (title == null) {
      continue;
    }
    $tbody.append($tr = $('<tr>'));
