...
enter_node = function(nodes) {
  ...
  g.append('g').attr('class', 'handles').each(function(node) {
    return d3.select(this).selectAll('.handles').data(node.handle_list()).enter().append('path').attr('class', function(handle) {
