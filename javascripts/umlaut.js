...
dot_lex = function(tokens) {
  ...
  parse_node = function() {
    var compass_pt, node, port, _ref55;
    if (tokens[pos] instanceof Keyword && tokens[pos].value === 'subgraph') {
      node = parse_subgraph();
      ...
      if (tokens[pos + 1] instanceof Delimiter && tokens[pos + 1].value === ':') {
        ...
        if (tokens[pos + 1] instanceof Delimiter && tokens[pos + 1].value === ':') {
          pos += 2;
          if (!(tokens[pos] instanceof Id) || (_ref55 = tokens[pos].value, __indexOf.call(COMPASS_PTS, _ref55) < 0)) {
...
dot = function(src) {
  ...
  populate = function(statements) {
    var attr, elt, i, label, node, prev_node, statement, sub_node, sub_prev_node, sub_prev_statement, sub_statement, _i, _len, _results;
    _results = [];
    for (_i = 0, _len = statements.length; _i < _len; _i++) {
      ...
      _results.push((function() {
        var _j, _k, _len1, _len2, _ref55, _ref56, _results1;
          ...
          if (i !== 0) {
            ...
            if (prev_node instanceof SubGraph) {
              _results1.push((function() {
                var _l, _len3, _ref57, _results2;
                _ref57 = prev_node.statements;
                _results2 = [];
                for (_l = 0, _len3 = _ref57.length; _l < _len3; _l++) {
                  sub_prev_statement = _ref57[_l];
                  _results2.push((function() {
                    var _len4, _m, _ref58, _results3;
                    _ref58 = sub_prev_statement.nodes;
                    _results3 = [];
                    for (_m = 0, _len4 = _ref58.length; _m < _len4; _m++) {
                      sub_prev_node = _ref58[_m];
                      if (node instanceof SubGraph) {
                        _results3.push((function() {
                          var _len5, _n, _ref59, _results4;
                          _ref59 = node.statements;
                          _results4 = [];
                          for (_n = 0, _len5 = _ref59.length; _n < _len5; _n++) {
                            sub_statement = _ref59[_n];
                            _results4.push((function() {
                              var _len6, _o, _ref60, _results5;
                              _ref60 = sub_statement.nodes;
                              _results5 = [];
                              for (_o = 0, _len6 = _ref60.length; _o < _len6; _o++) {
                                sub_node = _ref60[_o];
              ...
              if (node instanceof SubGraph) {
                _results1.push((function() {
                  var _l, _len3, _ref57, _results2;
                  _ref57 = node.statements;
                  _results2 = [];
                  for (_l = 0, _len3 = _ref57.length; _l < _len3; _l++) {
                    sub_statement = _ref57[_l];
                    _results2.push((function() {
                      var _len4, _m, _ref58, _results3;
                      _ref58 = sub_statement.nodes;
                      _results3 = [];
                      for (_m = 0, _len4 = _ref58.length; _m < _len4; _m++) {
                        sub_node = _ref58[_m];
