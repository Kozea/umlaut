...
commands = {
  ...
  edit: {
    fun: function() {
      edit((function() {
        ...
        var elt, _i, _len, _ref35, _results;
        _ref35 = diagram.selection;
        _results = [];
        for (_i = 0, _len = _ref35.length; _i < _len; _i++) {
          elt = _ref35[_i];
  ...
  remove: {
    fun: function() {
      var elt, lnk, _i, _j, _len, _len1, _ref35, _ref36;
      _ref35 = diagram.selection;
      for (_i = 0, _len = _ref35.length; _i < _len; _i++) {
        elt = _ref35[_i];
...
enter_node = function(node) {
  var g;
  g = node.append('g').attr('class', node instanceof Group ? 'group' : 'element');
