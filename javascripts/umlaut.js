...
var Actor, Association, Case, Database, Decision, Delay, Diagram, Document, Element, Ellipsis, Flow, FlowChart, HardDisk, IO, Inheritance, InternalStorage, Link, Lozenge, ManualInput, Mouse, Preparation, Process, Rect, SubProcess, Svg, Terminator, UseCase, commands, dist, edit, element_add, generate_url, history_pop, init_commands, link_add, list_diagrams, load, mouse_xy, save, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
...
Terminator = (function(_super) {
  ...
  function Terminator() {
    _ref5 = Terminator.__super__.constructor.apply(this, arguments);
    return _ref5;
  }
...
Delay = (function(_super) {
  ...
  function Delay() {
    _ref6 = Delay.__super__.constructor.apply(this, arguments);
    return _ref6;
  }
...
SubProcess = (function(_super) {
  ...
  function SubProcess() {
    _ref7 = SubProcess.__super__.constructor.apply(this, arguments);
    return _ref7;
  }
...
Document = (function(_super) {
  ...
  function Document() {
    _ref8 = Document.__super__.constructor.apply(this, arguments);
    return _ref8;
  }
...
Database = (function(_super) {
  ...
  function Database() {
    _ref9 = Database.__super__.constructor.apply(this, arguments);
    return _ref9;
  }
...
HardDisk = (function(_super) {
  ...
  function HardDisk() {
    _ref10 = HardDisk.__super__.constructor.apply(this, arguments);
    return _ref10;
  }
...
Preparation = (function(_super) {
  ...
  function Preparation() {
    _ref11 = Preparation.__super__.constructor.apply(this, arguments);
    return _ref11;
  }
...
InternalStorage = (function(_super) {
  ...
  function InternalStorage() {
    _ref12 = InternalStorage.__super__.constructor.apply(this, arguments);
    return _ref12;
  }
...
Flow = (function(_super) {
  ...
  function Flow() {
    _ref13 = Flow.__super__.constructor.apply(this, arguments);
    return _ref13;
  }
...
Case = (function(_super) {
  ...
  function Case() {
    _ref14 = Case.__super__.constructor.apply(this, arguments);
    return _ref14;
  }
...
Actor = (function(_super) {
  ...
  function Actor() {
    _ref15 = Actor.__super__.constructor.apply(this, arguments);
    return _ref15;
  }
...
commands = {
  ...
  edit: {
    fun: function() {
      edit((function() {
        ...
        var elt, _i, _len, _ref18, _results;
        _ref18 = diagram.selection;
        _results = [];
        for (_i = 0, _len = _ref18.length; _i < _len; _i++) {
          elt = _ref18[_i];
  ...
  remove: {
    fun: function() {
      var elt, lnk, _i, _j, _len, _len1, _ref18, _ref19;
      _ref18 = diagram.selection;
      for (_i = 0, _len = _ref18.length; _i < _len; _i++) {
        elt = _ref18[_i];
        diagram.elements.splice(diagram.elements.indexOf(elt), 1);
        _ref19 = diagram.links.slice();
...
init_commands = function() {
  var e, e1, e2, fun, g, hotkey, i, icon, key, l, margin, path, svgicon, taken_hotkeys, txt, _i, _j, _len, _len1, _ref18, _ref19, _results;
  taken_hotkeys = [];
...
Svg = (function() {
  function Svg() {
    ...
    this.drag = this.force.drag().on("drag.force", function(elt) {
      var delta, _i, _len, _ref18, _ref19;
      if (!diagram.dragging || d3.event.sourceEvent.ctrlKey) {
        return;
      }
      if (_ref18 = !elt, __indexOf.call(diagram.selection, _ref18) >= 0) {
    ...
    this.zoom = d3.behavior.zoom().scale(diagram.zoom.scale).translate(diagram.zoom.translate).scaleExtent([.15, 5]).on("zoom", function() {
      var _ref18;
      if (!d3.event.sourceEvent || ((_ref18 = d3.event.sourceEvent.type) === 'wheel' || _ref18 === 'click') || d3.event.sourceEvent.ctrlKey || d3.event.sourceEvent.which === 2) {
  ...
  Svg.prototype.sync = function() {
    ...
    element_g = this.element.enter().append('g').attr('class', 'element').call(this.drag).on("mousedown", function(elt) {
      ...
      var lnk, _i, _len, _ref18, _results;
      if (d3.event.ctrlKey) {
        return;
      }
      _ref18 = diagram.linking;
      _results = [];
      for (_i = 0, _len = _ref18.length; _i < _len; _i++) {
        lnk = _ref18[_i];
    ...
    this.element.select('text').each(function(elt) {
      var i, line, tspan, txt, _i, _len, _ref18, _results;
      txt = d3.select(this);
      if (elt.text === txt.text) {
        return;
      }
      txt.selectAll('tspan').remove();
      _ref18 = elt.text.split('\n');
      _results = [];
  ...
  Svg.prototype.tick = function() {
    var elt, need_force, _i, _len, _ref18;
    need_force = false;
    _ref18 = diagram.elements;
    for (_i = 0, _len = _ref18.length; _i < _len; _i++) {
      elt = _ref18[_i];
...
list_diagrams = function() {
  var $tbody, $tr, $ul, b64_diagram, diagram, key, name, title, type, _ref18, _ref19, _results;
  $tbody = $('#diagrams tbody');
  $tbody.find('.local').remove();
  for (key in localStorage) {
    b64_diagram = localStorage[key];
    _ref18 = key.split('|'), type = _ref18[0], title = _ref18[1];
    if (title == null) {
      continue;
    }
    $tbody.append($tr = $('<tr>'));
