...
var Actor, Association, Case, Container, Database, Decision, Delay, Diagram, Document, Element, Ellipsis, Flow, FlowChart, Group, HardDisk, IO, Inheritance, InternalStorage, Link, Lozenge, ManualInput, Mouse, Preparation, Process, Rect, SubProcess, Svg, System, Terminator, UseCase, commands, dist, edit, element_add, generate_url, history_pop, init_commands, link_add, list_diagrams, load, mouse_xy, save, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
...
Diagram = (function() {
  ...
  Diagram.prototype.group = function(name) {
    var grp, _i, _len, _ref1;
    _ref1 = this.types.groups;
  ...
  Diagram.prototype.loads = function(obj) {
    var element, elt, group, group_type, grp, link, lnk, _i, _j, _k, _len, _len1, _len2, _ref1, _ref2, _ref3, _results;
    if (obj.title) {
...
Lozenge = (function(_super) {
  ...
  Lozenge.prototype.width = function() {
    ...
    return ow + Math.sqrt(ow * this.txt_height());
  };

  Lozenge.prototype.height = function() {
    var oh;
    oh = Lozenge.__super__.height.call(this);
    return oh + Math.sqrt(oh * this.txt_width());
  };
...
Group = (function(_super) {
  ...
  function Group() {
    _ref4 = Group.__super__.constructor.apply(this, arguments);
    return _ref4;
  }
  ...
  Group.prototype.contains = function(elt) {
    var h2, w2, _ref5, _ref6;
    w2 = this.width() / 2;
    h2 = this.height() / 2;
    return (this.x - w2 < (_ref5 = elt.x) && _ref5 < this.x + w2) && (this.y - h2 < (_ref6 = elt.y) && _ref6 < this.y + h2);
  };

  Group.prototype.objectify = function() {
    return {
      name: this.constructor.name,
      x: this.x,
      y: this.y,
...
Process = (function(_super) {
  ...
  function Process() {
    _ref5 = Process.__super__.constructor.apply(this, arguments);
    return _ref5;
  }
...
IO = (function(_super) {
  ...
  IO.prototype.width = function() {
    return IO.__super__.width.call(this) + this.height();
  };
...
Delay = (function(_super) {
  ...
  function Delay() {
    _ref7 = Delay.__super__.constructor.apply(this, arguments);
    return _ref7;
  }
  ...
  Delay.prototype.txt_width = function() {
    return Math.max(0, Delay.__super__.txt_width.call(this) - this.txt_height() / 3);
  };
...
SubProcess = (function(_super) {
  ...
  function SubProcess() {
    _ref8 = SubProcess.__super__.constructor.apply(this, arguments);
    return _ref8;
  }
...
Document = (function(_super) {
  ...
  function Document() {
    _ref9 = Document.__super__.constructor.apply(this, arguments);
    return _ref9;
  }
...
Database = (function(_super) {
  ...
  function Database() {
    _ref10 = Database.__super__.constructor.apply(this, arguments);
    return _ref10;
  }

  Database.prototype.height = function() {
    return Database.__super__.height.call(this) + 2.5 * Math.min(this.width() / 3, Database.__super__.height.call(this) / 2);
  };

  Database.prototype.txt_y = function() {
    return Database.__super__.txt_y.call(this) + Math.min(this.width() / 3, this.txt_height() / 2) / 2;
  };

  Database.prototype.path = function() {
    var h2, r, w2;
    w2 = this.width() / 2;
    h2 = this.txt_height() / 2;
    r = Math.min(this.width() / 3, h2) * .9;
    h2 += r / 2;
...
HardDisk = (function(_super) {
  ...
  function HardDisk() {
    _ref11 = HardDisk.__super__.constructor.apply(this, arguments);
    return _ref11;
  }

  HardDisk.prototype.width = function() {
    return HardDisk.__super__.width.call(this) + 2.5 * Math.min(HardDisk.__super__.width.call(this) / 2, this.height() / 3);
  };

  HardDisk.prototype.txt_x = function() {
    return HardDisk.__super__.txt_x.call(this) - Math.min(this.txt_width() / 2, this.height() / 3) / 2;
  };
  ...
  HardDisk.prototype.path = function() {
    ...
    w2 = this.txt_width() / 2;
    h2 = this.height() / 2;
    r = Math.min(w2, this.height() / 3);
    w2 += r / 2;
    return "M " + w2 + " " + h2 + "         A " + r + " " + h2 + " 0 1 1 " + w2 + " " + (-h2) + "         A " + r + " " + h2 + " 0 1 1 " + w2 + " " + h2 + "         L " + (-w2) + " " + h2 + "         A " + r + " " + h2 + " 0 1 1 " + (-w2) + " " + (-h2) + "         L " + w2 + " " + (-h2) + "        ";
  };
...
ManualInput = (function(_super) {
  ...
  ManualInput.prototype.shift = 1.5;
  ...
  function ManualInput() {
    ...
    this.anchors.N = function() {
      return {
        x: _this.x,
        y: _this.y - _this.txt_height() / 2
      };
    };
  }

  ManualInput.prototype.height = function() {
    return ManualInput.__super__.height.call(this) * this.shift;
  };

  ManualInput.prototype.txt_y = function() {
    return ManualInput.__super__.txt_y.call(this) + (this.height() - this.txt_height()) / 2;
  };
  ...
  ManualInput.prototype.path = function() {
    ...
    w2 = this.width() / 2;
    h2 = this.height() / 2;
    th2 = this.txt_height() - this.height() / 2;
...
Preparation = (function(_super) {
  ...
  function Preparation() {
    _ref12 = Preparation.__super__.constructor.apply(this, arguments);
    return _ref12;
  }

  Preparation.prototype.width = function() {
    return Preparation.__super__.width.call(this) + this.height();
  };
  ...
  Preparation.prototype.path = function() {
    ...
    w2 = this.txt_width() / 2;
    h2 = this.height() / 2;
    return "M " + (-w2 - h2) + " 0         L " + (-w2) + " " + (-h2) + "         L " + w2 + " " + (-h2) + "         L " + (w2 + h2) + " 0         L " + w2 + " " + h2 + "         L " + (-w2) + " " + h2 + "         z";
  };
...
InternalStorage = (function(_super) {
  ...
  function InternalStorage() {
    _ref13 = InternalStorage.__super__.constructor.apply(this, arguments);
    return _ref13;
  }

  InternalStorage.prototype.shift = 10;

  InternalStorage.prototype.width = function() {
    return InternalStorage.__super__.width.call(this) + this.shift;
  };

  InternalStorage.prototype.height = function() {
    return InternalStorage.__super__.height.call(this) + this.shift;
  };

  InternalStorage.prototype.txt_x = function() {
    return InternalStorage.__super__.txt_x.call(this) + this.shift / 2;
  };

  InternalStorage.prototype.txt_y = function() {
    return InternalStorage.__super__.txt_y.call(this) + this.shift / 2;
  };
  ...
  InternalStorage.prototype.path = function() {
    ...
    w2 = this.width() / 2;
    h2 = this.height() / 2;
    return "" + (InternalStorage.__super__.path.call(this)) + "         M " + (-w2 + this.shift) + " " + (-h2) + "         L " + (-w2 + this.shift) + " " + h2 + "         M " + (-w2) + " " + (-h2 + this.shift) + "         L " + w2 + " " + (-h2 + this.shift) + "        ";
  };
...
Flow = (function(_super) {
  ...
  function Flow() {
    _ref14 = Flow.__super__.constructor.apply(this, arguments);
    return _ref14;
  }
...
Container = (function(_super) {
  ...
  function Container() {
    _ref15 = Container.__super__.constructor.apply(this, arguments);
    return _ref15;
  }
...
Case = (function(_super) {
  ...
  function Case() {
    _ref16 = Case.__super__.constructor.apply(this, arguments);
    return _ref16;
  }
...
Actor = (function(_super) {
  ...
  function Actor() {
    _ref17 = Actor.__super__.constructor.apply(this, arguments);
    return _ref17;
  }
  ...
  Actor.prototype.txt_y = function() {
    return this.height() / 2 - this.txt_height() + 2 * this.margin.y;
  };

  Actor.prototype.path = function() {
    var bottom;
    bottom = this.height() / 2 - this.txt_height() + this.margin.y;
    return "M " + (-this.stick) + " " + bottom + "         L 0 " + (bottom - this.stick) + "         M " + this.stick + " " + bottom + "         L 0 " + (bottom - this.stick) + "         M 0 " + (bottom - this.stick) + "         L 0 " + (bottom - 2 * this.stick) + "         M " + (-this.stick) + " " + (bottom - 1.75 * this.stick) + "         L " + this.stick + " " + (bottom - 2.25 * this.stick) + "         M 0 " + (bottom - 2 * this.stick) + "         L 0 " + (bottom - 3 * this.stick) + "         A " + (.5 * this.stick) + " " + (.5 * this.stick) + " 0 1 1 0 " + (bottom - 4 * this.stick) + "         A " + (.5 * this.stick) + " " + (.5 * this.stick) + " 0 1 1 0 " + (bottom - 3 * this.stick) + "         ";
  };
...
Association = (function(_super) {
  ...
  function Association() {
    _ref18 = Association.__super__.constructor.apply(this, arguments);
    return _ref18;
  }
...
Inheritance = (function(_super) {
  ...
  function Inheritance() {
    _ref19 = Inheritance.__super__.constructor.apply(this, arguments);
    return _ref19;
  }
...
System = (function(_super) {
  ...
  function System() {
    _ref20 = System.__super__.constructor.apply(this, arguments);
    return _ref20;
  }
...
element_add = function(type) {
  ...
  if (d3.event) {
    node = null;
    d3.selectAll('g.element,g.group').each(function(elt) {
      if (elt === new_elt) {
        node = this;
...
commands = {
  ...
  edit: {
    fun: function() {
      edit((function() {
        ...
        var elt, _i, _len, _ref21, _results;
        _ref21 = diagram.selection;
        _results = [];
        for (_i = 0, _len = _ref21.length; _i < _len; _i++) {
          elt = _ref21[_i];
  ...
  remove: {
    fun: function() {
      var elt, lnk, _i, _j, _len, _len1, _ref21, _ref22;
      _ref21 = diagram.selection;
      for (_i = 0, _len = _ref21.length; _i < _len; _i++) {
        elt = _ref21[_i];
...
({
  ...
  defaultscale: {
    fun: function() {
      ...
      return svg.zoom.event(svg.background_g);
    },
    label: 'Reset view',
    glyph: 'screenshot',
...
init_commands = function() {
  var e, e1, e2, fun, g, hotkey, i, icon, key, l, margin, path, svgicon, taken_hotkeys, txt, _i, _j, _len, _len1, _ref21, _ref22, _results;
  taken_hotkeys = [];
  ...
  _ref21 = diagram.types.elements.concat(diagram.types.groups);
  for (_i = 0, _len = _ref21.length; _i < _len; _i++) {
    e = _ref21[_i];
    i = 1;
...
Svg = (function() {
  function Svg() {
    ...
    this.background_g = this.svg.append('g');
    this.background = this.background_g.append('rect').attr('class', 'background').attr('width', this.width).attr('height', this.height).attr('fill', 'url(#grid)');
    ...
    this.root = this.background_g.append('g').attr('class', 'root');
    ...
    this.drag = this.force.drag().on("drag.force", function(elt) {
      var delta, _i, _len, _ref21, _ref22;
      if (!diagram.dragging || d3.event.sourceEvent.ctrlKey) {
        return;
      }
      if (_ref21 = !elt, __indexOf.call(diagram.selection, _ref21) >= 0) {
    ...
    d3.select(window).on("mousemove", function() {
      ...
      if (d3.event.ctrlKey) {
        return _this.background.classed('move', true);
      }
    }).on("keyup", function() {
      return _this.background.classed('move', false);
    });
    this.root.append('g').attr('class', 'underlay');
    this.root.append('g').attr('class', 'groups');
    ...
    this.zoom = d3.behavior.zoom().scale(diagram.zoom.scale).translate(diagram.zoom.translate).scaleExtent([.15, 5]).on("zoom", function() {
      var _ref21;
      if (!d3.event.sourceEvent || ((_ref21 = d3.event.sourceEvent.type) === 'wheel' || _ref21 === 'click') || d3.event.sourceEvent.ctrlKey || d3.event.sourceEvent.which === 2) {
    ...
    this.background_g.call(this.zoom);
  ...
  Svg.prototype.sync = function() {
    var element_g, group_g, link_g,
      _this = this;
    this.zoom.scale(diagram.zoom.scale);
    this.zoom.translate(diagram.zoom.translate);
    this.zoom.event(this.background_g);
    this.title.text(diagram.title);
    this.force.nodes(diagram.nodes()).links(diagram.links);
    this.group = this.svg.select('g.groups').selectAll('g.group').data(diagram.groups);
    group_g = this.group.enter().append('g').attr("class", "group").call(this.drag).on("mousedown", function(grp) {
      var selected;
      if (d3.event.ctrlKey) {
        return;
      }
      ...
      if (d3.event.which !== 3) {
        return svg.svg.selectAll('g.element').each(function(elt) {
    ...
    group_g.append('text');
    this.group.select('text').each(function(elt) {
      var i, line, tspan, txt, _i, _len, _ref21, _results;
      txt = d3.select(this);
      if (elt.text === txt.text) {
        return;
      }
      txt.selectAll('tspan').remove();
      _ref21 = elt.text.split('\n');
      _results = [];
    ...
    this.group.select('path.shape').attr('d', function(grp) {
      return grp.path();
    });
    ...
    element_g = this.element.enter().append('g').attr('class', 'element').call(this.drag).on("mousedown", function(elt) {
      ...
      var lnk, _i, _len, _ref21, _results;
      if (d3.event.ctrlKey) {
        return;
      }
      _ref21 = diagram.linking;
      _results = [];
      for (_i = 0, _len = _ref21.length; _i < _len; _i++) {
        lnk = _ref21[_i];
  ...
  Svg.prototype.tick = function() {
    var elt, need_force, _i, _len, _ref21;
    need_force = false;
    _ref21 = diagram.nodes();
    for (_i = 0, _len = _ref21.length; _i < _len; _i++) {
      elt = _ref21[_i];
    ...
    this.group.attr("transform", (function(grp) {
      return "translate(" + grp.x + "," + grp.y + ")";
    }));
  ...
  Svg.prototype.resize = function() {
    ...
    return this.background.attr("width", this.width).attr("height", this.height);
  };
...
list_diagrams = function() {
  var $tbody, $tr, $ul, b64_diagram, diagram, key, name, title, type, _ref21, _ref22, _results;
  $tbody = $('#diagrams tbody');
  $tbody.find('.local').remove();
  for (key in localStorage) {
    b64_diagram = localStorage[key];
    _ref21 = key.split('|'), type = _ref21[0], title = _ref21[1];
    if (title == null) {
      continue;
    }
    $tbody.append($tr = $('<tr>'));
