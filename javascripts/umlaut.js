...
Diagrams.Dot = (function(_super) {
  ...
  Dot.prototype.to_dot = function() {
    var attrs, directed, dot, element, key, link, op, shape, val, _i, _j, _len, _len1, _ref48, _ref49, _ref50, _ref51;
    directed = false;
    dot = "graph umlaut {\n";
...
commands = {
  ...
  cycle_start_marker: {
    fun: function() {
      var link, node, _i, _j, _len, _len1, _ref93, _ref94;
      _ref93 = diagram.selection;
      for (_i = 0, _len = _ref93.length; _i < _len; _i++) {
        node = _ref93[_i];
        if (node instanceof Link) {
