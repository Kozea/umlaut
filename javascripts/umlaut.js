...
BlackDot = (function(_super) {
  ...
  BlackDot.prototype.path = function() {
    return 'M 10 5 A 5 5 0 1 1 20 5 A 5 5 0 1 1 10 5';
  };
...
E.Diamond = (function(_super) {
  ...
  function Diamond() {
    _ref41 = Diamond.__super__.constructor.apply(this, arguments);
    return _ref41;
  }
...
E.House = (function(_super) {
  ...
  function House() {
    _ref44 = House.__super__.constructor.apply(this, arguments);
    return _ref44;
  }
...
E.Note = (function(_super) {
  ...
  function Note() {
    _ref45 = Note.__super__.constructor.apply(this, arguments);
    return _ref45;
  }
...
L.None = (function(_super) {
  ...
  function None() {
    _ref46 = None.__super__.constructor.apply(this, arguments);
    return _ref46;
  }
...
L.Curve = (function(_super) {
  ...
  function Curve() {
    _ref47 = Curve.__super__.constructor.apply(this, arguments);
    return _ref47;
  }
...
L.Normal = (function(_super) {
  ...
  function Normal() {
    _ref48 = Normal.__super__.constructor.apply(this, arguments);
    return _ref48;
  }
...
L.Onormal = (function(_super) {
  ...
  function Onormal() {
    _ref49 = Onormal.__super__.constructor.apply(this, arguments);
    return _ref49;
  }
...
L.Odiamond = (function(_super) {
  ...
  function Odiamond() {
    _ref51 = Odiamond.__super__.constructor.apply(this, arguments);
    return _ref51;
  }
...
L.Dot = (function(_super) {
  ...
  function Dot() {
    _ref52 = Dot.__super__.constructor.apply(this, arguments);
    return _ref52;
  }
...
L.Odot = (function(_super) {
  ...
  function Odot() {
    _ref53 = Odot.__super__.constructor.apply(this, arguments);
    return _ref53;
  }
...
Diagrams.UseCase.prototype.types.elements.Case = (function(_super) {
  ...
  function Case() {
    _ref54 = Case.__super__.constructor.apply(this, arguments);
    return _ref54;
  }
...
Diagrams.UseCase.prototype.types.groups.System = (function(_super) {
  ...
  function System() {
    _ref55 = System.__super__.constructor.apply(this, arguments);
    return _ref55;
  }
...
Diagrams.UseCase.prototype.types.links.Association = (function(_super) {
  ...
  function Association() {
    _ref56 = Association.__super__.constructor.apply(this, arguments);
    return _ref56;
  }
...
Diagrams.UseCase.prototype.types.links.Inheritance = (function(_super) {
  ...
  function Inheritance() {
    _ref57 = Inheritance.__super__.constructor.apply(this, arguments);
    return _ref57;
  }
...
Diagrams.UseCase.prototype.types.links.Aggregation = (function(_super) {
  ...
  function Aggregation() {
    _ref58 = Aggregation.__super__.constructor.apply(this, arguments);
    return _ref58;
  }
...
Diagrams.UseCase.prototype.types.links.Composition = (function(_super) {
  ...
  function Composition() {
    _ref59 = Composition.__super__.constructor.apply(this, arguments);
    return _ref59;
  }
...
Diagrams.UseCase.prototype.types.links.Comment = (function(_super) {
  ...
  function Comment() {
    _ref60 = Comment.__super__.constructor.apply(this, arguments);
    return _ref60;
  }
...
Electric = (function(_super) {
  ...
  function Electric() {
    _ref61 = Electric.__super__.constructor.apply(this, arguments);
    return _ref61;
  }
...
E.Resistor = (function(_super) {
  ...
  function Resistor() {
    _ref62 = Resistor.__super__.constructor.apply(this, arguments);
    return _ref62;
  }
...
E.Diode = (function(_super) {
  ...
  function Diode() {
    _ref63 = Diode.__super__.constructor.apply(this, arguments);
    return _ref63;
  }
...
E.Battery = (function(_super) {
  ...
  function Battery() {
    _ref64 = Battery.__super__.constructor.apply(this, arguments);
    return _ref64;
  }
...
E.PNPTransistor = (function(_super) {
  ...
  function PNPTransistor() {
    _ref65 = PNPTransistor.__super__.constructor.apply(this, arguments);
    return _ref65;
  }
...
E.NPNTransistor = (function(_super) {
  ...
  function NPNTransistor() {
    _ref66 = NPNTransistor.__super__.constructor.apply(this, arguments);
    return _ref66;
  }
...
Diagrams.Electric.prototype.types.links.Wire = (function(_super) {
  ...
  function Wire() {
    _ref67 = Wire.__super__.constructor.apply(this, arguments);
    return _ref67;
  }
...
Diagrams.Class.prototype.types.elements.Class = (function(_super) {
  ...
  function Class() {
    _ref69 = Class.__super__.constructor.apply(this, arguments);
    return _ref69;
  }
...
commands = {
  ...
  edit: {
    fun: function() {
      return edit((function() {
        ...
        var node, _i, _len, _ref76, _results;
        _ref76 = diagram.selection;
        _results = [];
        for (_i = 0, _len = _ref76.length; _i < _len; _i++) {
          node = _ref76[_i];
  ...
  remove: {
    fun: function() {
      var lnk, node, _i, _j, _len, _len1, _ref76, _ref77;
      _ref76 = diagram.selection;
      for (_i = 0, _len = _ref76.length; _i < _len; _i++) {
        node = _ref76[_i];
        ...
        _ref77 = diagram.links.slice();
        for (_j = 0, _len1 = _ref77.length; _j < _len1; _j++) {
          lnk = _ref77[_j];
  ...
  snaptogrid: {
    fun: function() {
      var node, _i, _len, _ref76;
      _ref76 = diagram.nodes();
      for (_i = 0, _len = _ref76.length; _i < _len; _i++) {
        node = _ref76[_i];
  ...
  "switch": {
    fun: function() {
      var link, node, _i, _j, _len, _len1, _ref76, _ref77, _ref78, _ref79;
      _ref76 = diagram.selection;
      for (_i = 0, _len = _ref76.length; _i < _len; _i++) {
        node = _ref76[_i];
        if (node instanceof Link) {
          _ref77 = [node.target, node.source], node.source = _ref77[0], node.target = _ref77[1];
        }
        if (node instanceof Element) {
          _ref78 = diagram.links;
          for (_j = 0, _len1 = _ref78.length; _j < _len1; _j++) {
            link = _ref78[_j];
            _ref79 = [link.target, link.source], link.source = _ref79[0], link.target = _ref79[1];
          }
        }
      }
      return svg.tick();
...
init_commands = function() {
  var cls, conf, e1, e2, element, first, fun, hotkey, i, icon, inc, key, link, margin, name, svgicon, taken_hotkeys, val, way, _ref76, _ref77, _ref78, _ref79, _results;
  _ref76 = diagram.force_conf;
  for (conf in _ref76) {
    val = _ref76[conf];
    _ref77 = {
      increase: 1.1,
  ...
  _ref78 = merge_copy(diagram.types.elements, diagram.types.groups);
  for (name in _ref78) {
    cls = _ref78[name];
    i = 1;
...
edit = function(getter, setter) {
  ...
  textarea.on('input', function() {
    var val;
    setter(((function() {
      var _i, _len, _ref76, _results;
      _ref76 = this.value.split('\n');
      _results = [];
      for (_i = 0, _len = _ref76.length; _i < _len; _i++) {
        val = _ref76[_i];
        _results.push(val || ' ');
...
move_drag = d3.behavior.drag().on('dragstart', function(node) {
  ...
  var delta, x, y, _i, _j, _len, _len1, _ref76, _ref77, _ref78;
  if (!diagram.dragging || d3.event.sourceEvent.ctrlKey) {
    return;
  }
  x = diagram.force ? 'px' : 'x';
  y = diagram.force ? 'py' : 'y';
  if (_ref76 = !node, __indexOf.call(diagram.selection, _ref76) >= 0) {
    diagram.selection.push(node);
  }
  _ref77 = diagram.selection;
  for (_i = 0, _len = _ref77.length; _i < _len; _i++) {
    node = _ref77[_i];
    node.fixed = true;
  }
  ...
  var lnk, _i, _j, _len, _len1, _ref76, _ref77;
...
mouse_anchor = function(anchor) {
  ...
  return anchor.on("mousemove", function(anchor) {
    var lnk, node, _i, _len, _ref76, _results;
    if (d3.event.ctrlKey) {
      return;
    }
    d3.select(this).classed('active', true);
    node = d3.select($(this).closest('.node').get(0)).data()[0];
    _ref76 = diagram.linking;
    _results = [];
    for (_i = 0, _len = _ref76.length; _i < _len; _i++) {
      lnk = _ref76[_i];
    ...
    var lnk, _i, _len, _ref76, _results;
    if (d3.event.ctrlKey) {
      return;
    }
    ...
    var lnk, node, _i, _len, _ref76, _ref77;
    if (d3.event.ctrlKey) {
      return;
    }
    ...
    if (diagram.linking.length) {
      ...
      for (_i = 0, _len = _ref76.length; _i < _len; _i++) {
        lnk = _ref76[_i];
        if ((_ref77 = diagram.mouse) !== lnk.source && _ref77 !== lnk.target) {
...
write_text = function(txt, text) {
  var i, line, tspan, _i, _len, _ref76, _results;
  txt.selectAll('tspan').remove();
  _ref76 = text.split('\n');
  _results = [];
  for (i = _i = 0, _len = _ref76.length; _i < _len; i = ++_i) {
    line = _ref76[i];
...
Svg = (function(_super) {
  ...
  function Svg() {
    ...
    this.zoom = zoom.scale(diagram.zoom.scale).translate(diagram.zoom.translate).scaleExtent([.05, 5]).on("zoom", function() {
      var _ref76;
      if (((_ref76 = d3.event.sourceEvent.type) === 'wheel' || _ref76 === 'click') || d3.event.sourceEvent.ctrlKey || d3.event.sourceEvent.which === 2) {
...
list_diagrams = function() {
  var $tbody, $tr, b64_diagram, diagram, key, name, title, type, _ref76, _results;
  $tbody = $('#diagrams tbody');
  $tbody.find('.local').remove();
  for (key in localStorage) {
    b64_diagram = localStorage[key];
    _ref76 = key.split('|'), type = _ref76[0], title = _ref76[1];
    if (title == null) {
      continue;
    }
    $tbody.append($tr = $('<tr>'));
...
Keyword = (function(_super) {
  ...
  function Keyword() {
    _ref76 = Keyword.__super__.constructor.apply(this, arguments);
    return _ref76;
  }
...
Id = (function(_super) {
  ...
  function Id() {
    _ref77 = Id.__super__.constructor.apply(this, arguments);
    return _ref77;
  }
...
Number = (function(_super) {
  ...
  function Number() {
    _ref78 = Number.__super__.constructor.apply(this, arguments);
    return _ref78;
  }
...
QuotedId = (function(_super) {
  ...
  function QuotedId() {
    _ref79 = QuotedId.__super__.constructor.apply(this, arguments);
    return _ref79;
  }
...
Brace = (function(_super) {
  ...
  function Brace() {
    _ref80 = Brace.__super__.constructor.apply(this, arguments);
    return _ref80;
  }
...
Delimiter = (function(_super) {
  ...
  function Delimiter() {
    _ref81 = Delimiter.__super__.constructor.apply(this, arguments);
    return _ref81;
  }
...
Assign = (function(_super) {
  ...
  function Assign() {
    _ref82 = Assign.__super__.constructor.apply(this, arguments);
    return _ref82;
  }
...
Operator = (function(_super) {
  ...
  function Operator() {
    _ref83 = Operator.__super__.constructor.apply(this, arguments);
    return _ref83;
  }
...
dot_tokenize = function(s) {
  var chr, col, escape, id, last_chr, len, op, pos, row, token, tokens, _ref84, _ref85;
  pos = 0;
  row = 0;
  col = 0;
  len = s.length;
  ...
  while (pos < len) {
    ...
    if (chr.match(/\s/)) {
      ...
      id = chr;
      while ((_ref84 = (chr = s[pos++])) != null ? _ref84.match(/\w/) : void 0) {
        id += chr;
      }
      pos--;
      ...
      id = chr;
      while ((_ref85 = (chr = s[pos++])) != null ? _ref85.match(/\d|\./) : void 0) {
        id += chr;
      }
      pos--;
...
Statement = (function() {
  ...
  Statement.prototype.get_attrs = function() {
    var attribute, attrs, _i, _len, _ref84;
    attrs = {};
    _ref84 = this.attributes;
    for (_i = 0, _len = _ref84.length; _i < _len; _i++) {
      attribute = _ref84[_i];
...
dot_lex = function(tokens) {
  ...
  parse_node = function() {
    var compass_pt, node, port, _ref84;
    if (tokens[pos] instanceof Keyword && tokens[pos].value === 'subgraph') {
      node = parse_subgraph();
      ...
      if (tokens[pos + 1] instanceof Delimiter && tokens[pos + 1].value === ':') {
        ...
        if (tokens[pos + 1] instanceof Delimiter && tokens[pos + 1].value === ':') {
          pos += 2;
          if (!(tokens[pos] instanceof Id) || (_ref84 = tokens[pos].value, __indexOf.call(COMPASS_PTS, _ref84) < 0)) {
  ...
  parse_statement = function() {
    var left, statement, _ref84;
    if (tokens[pos] instanceof Brace && tokens[pos].value === '}') {
      return null;
    }
    if (tokens[pos] instanceof Keyword && tokens[pos].value !== 'subgraph') {
      if ((_ref84 = tokens[pos].value) !== 'graph' && _ref84 !== 'node' && _ref84 !== 'edge') {
  ...
  populate = function(statements) {
    ...
    for (_i = 0, _len = statements.length; _i < _len; _i++) {
      ...
      _results.push((function() {
        var _j, _len1, _ref84, _results1;
        _ref84 = statement.nodes;
        _results1 = [];
        for (i = _j = 0, _len1 = _ref84.length; _j < _len1; i = ++_j) {
          node = _ref84[i];
          ...
          if (i !== 0) {
            ...
            if (prev_node instanceof SubGraph) {
              _results1.push((function() {
                var _k, _len2, _ref85, _results2;
                _ref85 = prev_node.statements;
                _results2 = [];
                for (_k = 0, _len2 = _ref85.length; _k < _len2; _k++) {
                  sub_prev_statement = _ref85[_k];
                  _results2.push((function() {
                    var _l, _len3, _ref86, _results3;
                    _ref86 = sub_prev_statement.nodes;
                    _results3 = [];
                    for (_l = 0, _len3 = _ref86.length; _l < _len3; _l++) {
                      sub_prev_node = _ref86[_l];
                      if (node instanceof SubGraph) {
                        _results3.push((function() {
                          var _len4, _m, _ref87, _results4;
                          _ref87 = node.statements;
                          _results4 = [];
                          for (_m = 0, _len4 = _ref87.length; _m < _len4; _m++) {
                            sub_statement = _ref87[_m];
                            _results4.push((function() {
                              var _len5, _n, _ref88, _results5;
                              _ref88 = sub_statement.nodes;
                              _results5 = [];
                              for (_n = 0, _len5 = _ref88.length; _n < _len5; _n++) {
                                sub_node = _ref88[_n];
              ...
              if (node instanceof SubGraph) {
                _results1.push((function() {
                  var _k, _len2, _ref85, _results2;
                  _ref85 = node.statements;
                  _results2 = [];
                  for (_k = 0, _len2 = _ref85.length; _k < _len2; _k++) {
                    sub_statement = _ref85[_k];
                    _results2.push((function() {
                      var _l, _len3, _ref86, _results3;
                      _ref86 = sub_statement.nodes;
                      _results3 = [];
                      for (_l = 0, _len3 = _ref86.length; _l < _len3; _l++) {
                        sub_node = _ref86[_l];
                        _results3.push(links_by_id.push({
