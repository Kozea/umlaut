...
Diagram = (function(_super) {
  ...
  Diagram.prototype.loads = function(obj) {
    ...
    if (obj.linkstyle) {
      this.linkstyle = new LinkStyles[obj.linkstyle]();
    }
    if (obj.zoom) {
      this.zoom = obj.zoom;
    }
...
bare_link = (function(_super) {
  ...
  function bare_link() {
    _ref29 = bare_link.__super__.constructor.apply(this, arguments);
    return _ref29;
  }
...
arrow = (function(_super) {
  ...
  function arrow() {
    _ref30 = arrow.__super__.constructor.apply(this, arguments);
    return _ref30;
  }
...
blackarrow = (function(_super) {
  ...
  function blackarrow() {
    _ref31 = blackarrow.__super__.constructor.apply(this, arguments);
    return _ref31;
  }
...
whitearrow = (function(_super) {
  ...
  function whitearrow() {
    _ref32 = whitearrow.__super__.constructor.apply(this, arguments);
    return _ref32;
  }
...
blackdiamond = (function(_super) {
  ...
  function blackdiamond() {
    _ref33 = blackdiamond.__super__.constructor.apply(this, arguments);
    return _ref33;
  }
...
whitediamond = (function(_super) {
  ...
  function whitediamond() {
    _ref34 = whitediamond.__super__.constructor.apply(this, arguments);
    return _ref34;
  }
...
dotted = (function(_super) {
  ...
  function dotted() {
    _ref35 = dotted.__super__.constructor.apply(this, arguments);
    return _ref35;
  }
...
Case = (function(_super) {
  ...
  function Case() {
    _ref46 = Case.__super__.constructor.apply(this, arguments);
    return _ref46;
  }
...
System = (function(_super) {
  ...
  function System() {
    _ref47 = System.__super__.constructor.apply(this, arguments);
    return _ref47;
  }
...
Electric = (function(_super) {
  ...
  function Electric() {
    _ref48 = Electric.__super__.constructor.apply(this, arguments);
    return _ref48;
  }
...
Resistor = (function(_super) {
  ...
  function Resistor() {
    _ref49 = Resistor.__super__.constructor.apply(this, arguments);
    return _ref49;
  }
...
Diode = (function(_super) {
  ...
  function Diode() {
    _ref50 = Diode.__super__.constructor.apply(this, arguments);
    return _ref50;
  }
...
Battery = (function(_super) {
  ...
  function Battery() {
    _ref51 = Battery.__super__.constructor.apply(this, arguments);
    return _ref51;
  }
...
PNPTransistor = (function(_super) {
  ...
  function PNPTransistor() {
    _ref52 = PNPTransistor.__super__.constructor.apply(this, arguments);
    return _ref52;
  }
...
NPNTransistor = (function(_super) {
  ...
  function NPNTransistor() {
    _ref53 = NPNTransistor.__super__.constructor.apply(this, arguments);
    return _ref53;
  }
...
Wire = (function(_super) {
  ...
  function Wire() {
    _ref54 = Wire.__super__.constructor.apply(this, arguments);
    return _ref54;
  }
...
Class = (function(_super) {
  ...
  function Class() {
    _ref55 = Class.__super__.constructor.apply(this, arguments);
    return _ref55;
  }
...
commands = {
  ...
  "export": {
    fun: function(e) {
      var content, css, rule, svg, _i, _len, _ref56;
      css = '';
      _ref56 = d3.select('#style').node().sheet.cssRules;
  ...
  edit: {
    fun: function() {
      return edit((function() {
        ...
        var node, _i, _len, _ref56, _results;
  ...
  remove: {
    fun: function() {
      var lnk, node, _i, _j, _len, _len1, _ref56, _ref57;
      _ref56 = diagram.selection;
      for (_i = 0, _len = _ref56.length; _i < _len; _i++) {
        node = _ref56[_i];
  ...
  snaptogrid: {
    fun: function() {
      var node, _i, _len, _ref56;
      _ref56 = diagram.nodes();
      for (_i = 0, _len = _ref56.length; _i < _len; _i++) {
        node = _ref56[_i];
  ...
  "switch": {
    fun: function() {
      var link, node, _i, _j, _len, _len1, _ref56, _ref57, _ref58, _ref59;
      _ref56 = diagram.selection;
      for (_i = 0, _len = _ref56.length; _i < _len; _i++) {
        node = _ref56[_i];
        if (node instanceof Link) {
          _ref57 = [node.target, node.source], node.source = _ref57[0], node.target = _ref57[1];
        }
        if (node instanceof Element) {
          _ref58 = diagram.links;
          for (_j = 0, _len1 = _ref58.length; _j < _len1; _j++) {
            link = _ref58[_j];
            _ref59 = [link.target, link.source], link.source = _ref59[0], link.target = _ref59[1];
          }
        }
      }
      return svg.tick();
...
init_commands = function() {
  var e, e1, e2, element, fun, hotkey, i, icon, key, l, link, margin, n, svgicon, taken_hotkeys, _i, _j, _len, _len1, _ref56, _ref57, _results;
  taken_hotkeys = [];
  ...
  _ref56 = diagram.types.elements.concat(diagram.types.groups);
  for (_i = 0, _len = _ref56.length; _i < _len; _i++) {
    e = _ref56[_i];
    i = 1;
  ...
  taken_hotkeys = [];
  _ref57 = diagram.types.links;
  _results = [];
  for (n = _j = 0, _len1 = _ref57.length; _j < _len1; n = ++_j) {
    l = _ref57[n];
    i = 1;
...
edit = function(getter, setter) {
  ...
  textarea.on('input', function() {
    var val;
    setter(((function() {
      var _i, _len, _ref56, _results;
      _ref56 = this.value.split('\n');
      _results = [];
      for (_i = 0, _len = _ref56.length; _i < _len; _i++) {
        val = _ref56[_i];
        _results.push(val || ' ');
...
move_drag = d3.behavior.drag().on('dragstart', function(node) {
  ...
  var delta, x, y, _i, _j, _len, _len1, _ref56, _ref57, _ref58;
  if (!diagram.dragging || d3.event.sourceEvent.ctrlKey) {
    return;
  }
  x = diagram.force ? 'px' : 'x';
  y = diagram.force ? 'py' : 'y';
  if (_ref56 = !node, __indexOf.call(diagram.selection, _ref56) >= 0) {
  ...
  var lnk, _i, _j, _len, _len1, _ref56, _ref57;
...
mouse_anchor = function(anchor) {
  ...
  return anchor.on("mousemove", function(anchor) {
    var lnk, node, _i, _len, _ref56, _results;
    if (d3.event.ctrlKey) {
      return;
    }
    d3.select(this).classed('active', true);
    node = d3.select($(this).closest('.node').get(0)).data()[0];
    _ref56 = diagram.linking;
    _results = [];
    for (_i = 0, _len = _ref56.length; _i < _len; _i++) {
      lnk = _ref56[_i];
    ...
    var lnk, _i, _len, _ref56, _results;
    if (d3.event.ctrlKey) {
      return;
    }
    ...
    var lnk, node, _i, _len, _ref56, _ref57;
    if (d3.event.ctrlKey) {
      return;
    }
    ...
    if (diagram.linking.length) {
      ...
      for (_i = 0, _len = _ref56.length; _i < _len; _i++) {
        lnk = _ref56[_i];
        if ((_ref57 = diagram.mouse) !== lnk.source && _ref57 !== lnk.target) {
...
write_text = function(txt, text) {
  var i, line, tspan, _i, _len, _ref56, _results;
  txt.selectAll('tspan').remove();
  _ref56 = text.split('\n');
  _results = [];
  for (i = _i = 0, _len = _ref56.length; _i < _len; i = ++_i) {
    line = _ref56[i];
...
Svg = (function(_super) {
  ...
  function Svg() {
    ...
    this.zoom = zoom.scale(diagram.zoom.scale).translate(diagram.zoom.translate).scaleExtent([.05, 5]).on("zoom", function() {
      var _ref56;
      if (!d3.event.sourceEvent || ((_ref56 = d3.event.sourceEvent.type) === 'wheel' || _ref56 === 'click') || d3.event.sourceEvent.ctrlKey || d3.event.sourceEvent.which === 2) {
...
list_diagrams = function() {
  ...
  for (key in localStorage) {
    ...
    _ref56 = key.split('|'), type = _ref56[0], title = _ref56[1];
    if (title == null) {
      continue;
    }
    $tbody.append($tr = $('<tr>'));
...
Keyword = (function(_super) {
  ...
  function Keyword() {
    _ref56 = Keyword.__super__.constructor.apply(this, arguments);
    return _ref56;
  }
...
Id = (function(_super) {
  ...
  function Id() {
    _ref57 = Id.__super__.constructor.apply(this, arguments);
    return _ref57;
  }
...
Number = (function(_super) {
  ...
  function Number() {
    _ref58 = Number.__super__.constructor.apply(this, arguments);
    return _ref58;
  }
...
QuotedId = (function(_super) {
  ...
  function QuotedId() {
    _ref59 = QuotedId.__super__.constructor.apply(this, arguments);
    return _ref59;
  }
...
Brace = (function(_super) {
  ...
  function Brace() {
    _ref60 = Brace.__super__.constructor.apply(this, arguments);
    return _ref60;
  }
...
Delimiter = (function(_super) {
  ...
  function Delimiter() {
    _ref61 = Delimiter.__super__.constructor.apply(this, arguments);
    return _ref61;
  }
...
Assign = (function(_super) {
  ...
  function Assign() {
    _ref62 = Assign.__super__.constructor.apply(this, arguments);
    return _ref62;
  }
...
Operator = (function(_super) {
  ...
  function Operator() {
    _ref63 = Operator.__super__.constructor.apply(this, arguments);
    return _ref63;
  }
...
dot_tokenize = function(s) {
  var chr, col, escape, id, last_chr, len, op, pos, row, token, tokens, _ref64, _ref65;
  pos = 0;
  row = 0;
  col = 0;
  len = s.length;
  ...
  while (pos < len) {
    ...
    if (chr.match(/\s/)) {
      ...
      id = chr;
      while ((_ref64 = (chr = s[pos++])) != null ? _ref64.match(/\w/) : void 0) {
        id += chr;
      }
      pos--;
      ...
      id = chr;
      while ((_ref65 = (chr = s[pos++])) != null ? _ref65.match(/\d|\./) : void 0) {
        id += chr;
      }
      pos--;
...
dot_lex = function(tokens) {
  ...
  parse_node = function() {
    var compass_pt, node, port, _ref64;
    if (tokens[pos] instanceof Keyword && tokens[pos].value === 'subgraph') {
      node = parse_subgraph();
      ...
      if (tokens[pos + 1] instanceof Delimiter && tokens[pos + 1].value === ':') {
        ...
        if (tokens[pos + 1] instanceof Delimiter && tokens[pos + 1].value === ':') {
          pos += 2;
          if (!(tokens[pos] instanceof Id) || (_ref64 = tokens[pos].value, __indexOf.call(COMPASS_PTS, _ref64) < 0)) {
  ...
  parse_statement = function() {
    var statement, _ref64;
    if (tokens[pos] instanceof Brace && tokens[pos].value === '}') {
      return null;
    }
    if (tokens[pos] instanceof Keyword && tokens[pos].value !== 'subgraph') {
      if ((_ref64 = tokens[pos].value) !== 'graph' && _ref64 !== 'node' && _ref64 !== 'edge') {
  ...
  populate = function(statements) {
    ...
    for (_i = 0, _len = statements.length; _i < _len; _i++) {
      ...
      _results.push((function() {
        var _j, _k, _len1, _len2, _ref64, _ref65, _results1;
        _ref64 = statement.nodes;
        _results1 = [];
        for (i = _j = 0, _len1 = _ref64.length; _j < _len1; i = ++_j) {
          node = _ref64[i];
          if (node instanceof SubGraph) {
            ...
            if (!(node.id in nodes_by_id)) {
              label = node.id;
              type = 'ellipse';
              _ref65 = statement.attributes;
              for (_k = 0, _len2 = _ref65.length; _k < _len2; _k++) {
                attr = _ref65[_k];
                if (attr.left === 'label') {
                  label = attr.right;
          ...
          if (i !== 0) {
            ...
            if (prev_node instanceof SubGraph) {
              _results1.push((function() {
                var _l, _len3, _ref66, _results2;
                _ref66 = prev_node.statements;
                _results2 = [];
                for (_l = 0, _len3 = _ref66.length; _l < _len3; _l++) {
                  sub_prev_statement = _ref66[_l];
                  _results2.push((function() {
                    var _len4, _m, _ref67, _results3;
                    _ref67 = sub_prev_statement.nodes;
                    _results3 = [];
                    for (_m = 0, _len4 = _ref67.length; _m < _len4; _m++) {
                      sub_prev_node = _ref67[_m];
                      if (node instanceof SubGraph) {
                        _results3.push((function() {
                          var _len5, _n, _ref68, _results4;
                          _ref68 = node.statements;
                          _results4 = [];
                          for (_n = 0, _len5 = _ref68.length; _n < _len5; _n++) {
                            sub_statement = _ref68[_n];
                            _results4.push((function() {
                              var _len6, _o, _ref69, _results5;
                              _ref69 = sub_statement.nodes;
                              _results5 = [];
                              for (_o = 0, _len6 = _ref69.length; _o < _len6; _o++) {
                                sub_node = _ref69[_o];
