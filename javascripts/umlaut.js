...
var Aggregation, Assign, Association, Attribute, Attributes, BRACES, Base, Brace, COMPASS_PTS, Comment, Composition, DELIMITERS, Delimiter, Diagram, Diagrams, E, Edge, Electric, Element, Ellipsis, Graph, Group, Hexagon, House, Id, Inheritance, KEYWORDS, Keyword, L, Link, LinkStyle, LinkStyles, Lozenge, Marker, Markers, Mouse, Node, Note, Number, OPERATORS, Octogon, Operator, PANIC_THRESHOLD, Parallelogram, Pentagon, Polygon, QuotedId, RE_ALPHA, RE_ALPHADIGIT, RE_COMMENT, RE_DIGIT, RE_SPACE, Rect, RemoteStorage, Septagon, Star, Statement, SubGraph, Svg, Token, Transistor, Trapezium, Triangle, anchor_link_drag, angle_to_cardinal, atan2, attach_self, capitalize, cardinal, cardinal_to_direction, commands, copy, dist, dot, dot_lex, dot_tokenize, edit, enter_link, enter_marker, enter_node, extern_drag, floating, generate_url, history_pop, init_commands, last_command, link_drag, list_diagrams, list_local, list_new, list_remote, load, merge, merge_copy, mod2pi, mouse_link, mouse_node, mouse_xy, move_drag, n, next, node_add, node_style, nsweo_resize_drag, order, pi, publish, remoteStorage, rotate, save, svg_selection_drag, t, text_style, tick_link, tick_node, timestamp, to_deg, to_rad, to_svg_angle, update_anchors, update_handles, update_link, update_marker, update_node, wrap, write_text, zoom, _ref, _ref1, _ref10, _ref100, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref25, _ref26, _ref27, _ref28, _ref29, _ref3, _ref30, _ref31, _ref32, _ref33, _ref34, _ref35, _ref36, _ref37, _ref38, _ref39, _ref4, _ref40, _ref41, _ref42, _ref43, _ref44, _ref45, _ref46, _ref47, _ref48, _ref49, _ref5, _ref50, _ref51, _ref52, _ref53, _ref54, _ref55, _ref56, _ref57, _ref58, _ref59, _ref6, _ref60, _ref61, _ref62, _ref63, _ref64, _ref65, _ref66, _ref67, _ref68, _ref69, _ref7, _ref70, _ref71, _ref72, _ref73, _ref74, _ref75, _ref76, _ref77, _ref78, _ref79, _ref8, _ref80, _ref81, _ref82, _ref83, _ref84, _ref85, _ref86, _ref87, _ref88, _ref89, _ref9, _ref90, _ref91, _ref92, _ref93, _ref94, _ref95, _ref96, _ref97, _ref98, _ref99,
...
Markers.Crow = (function(_super) {
  ...
  function Crow() {
    _ref9 = Crow.__super__.constructor.apply(this, arguments);
    return _ref9;
  }
...
Markers.Normal = (function(_super) {
  ...
  function Normal() {
    _ref10 = Normal.__super__.constructor.apply(this, arguments);
    return _ref10;
  }
...
Markers.Inv = (function(_super) {
  ...
  function Inv() {
    _ref11 = Inv.__super__.constructor.apply(this, arguments);
    return _ref11;
  }
...
Markers.Diamond = (function(_super) {
  ...
  function Diamond() {
    _ref12 = Diamond.__super__.constructor.apply(this, arguments);
    return _ref12;
  }
...
Markers.Dot = (function(_super) {
  ...
  function Dot() {
    _ref13 = Dot.__super__.constructor.apply(this, arguments);
    return _ref13;
  }
...
Markers.Box = (function(_super) {
  ...
  function Box() {
    _ref14 = Box.__super__.constructor.apply(this, arguments);
    return _ref14;
  }
...
Markers.Tee = (function(_super) {
  ...
  function Tee() {
    _ref15 = Tee.__super__.constructor.apply(this, arguments);
    return _ref15;
  }
...
Element = (function(_super) {
  ...
  Element.prototype.direction = function(x, y) {
    var anchor, deviation, diff, min_anchor, min_diff, pi2, pos, target, _ref16;
    pi2 = 2 * pi;
    target = atan2(y - this.y, x - this.x);
    min_diff = Infinity;
    _ref16 = this.anchors;
    for (anchor in _ref16) {
      pos = _ref16[anchor];
...
Mouse = (function(_super) {
  ...
  function Mouse() {
    _ref16 = Mouse.__super__.constructor.apply(this, arguments);
    return _ref16;
  }
...
Diagram = (function(_super) {
  ...
  Diagram.prototype.markers = function() {
    var key, markers, name, type, val, _ref17, _results;
    markers = {};
    _ref17 = this.types.links;
    for (name in _ref17) {
      type = _ref17[name];
  ...
  Diagram.prototype.loads = function(obj) {
    var element, element_type, elt, group, group_type, grp, link, link_type, lnk, _i, _j, _k, _len, _len1, _len2, _ref17, _ref18, _ref19, _ref20, _ref21;
    if (obj.title) {
    ...
    for (_k = 0, _len2 = _ref19.length; _k < _len2; _k++) {
      ...
      if ((_ref20 = link.attrs) != null ? _ref20.arrowhead : void 0) {
        link.marker_end = Markers._get(link.attrs.arrowhead);
      }
      if ((_ref21 = link.attrs) != null ? _ref21.arrowtail : void 0) {
...
Rect = (function(_super) {
  ...
  function Rect() {
    _ref17 = Rect.__super__.constructor.apply(this, arguments);
    return _ref17;
  }
...
Ellipsis = (function(_super) {
  ...
  function Ellipsis() {
    _ref18 = Ellipsis.__super__.constructor.apply(this, arguments);
    return _ref18;
  }
...
Lozenge = (function(_super) {
  ...
  function Lozenge() {
    _ref20 = Lozenge.__super__.constructor.apply(this, arguments);
    return _ref20;
  }
...
Triangle = (function(_super) {
  ...
  function Triangle() {
    _ref21 = Triangle.__super__.constructor.apply(this, arguments);
    return _ref21;
  }
...
Trapezium = (function(_super) {
  ...
  function Trapezium() {
    _ref22 = Trapezium.__super__.constructor.apply(this, arguments);
    return _ref22;
  }
...
Polygon = (function(_super) {
  ...
  Polygon.prototype.path = function() {
    ...
    angle = 2 * pi / this.n;
    path = '';
    for (i = _i = 0, _ref23 = this.n; 0 <= _ref23 ? _i <= _ref23 : _i >= _ref23; i = 0 <= _ref23 ? ++_i : --_i) {
...
Triangle = (function(_super) {
  ...
  function Triangle() {
    _ref23 = Triangle.__super__.constructor.apply(this, arguments);
    return _ref23;
  }
...
Pentagon = (function(_super) {
  ...
  function Pentagon() {
    _ref24 = Pentagon.__super__.constructor.apply(this, arguments);
    return _ref24;
  }
...
Hexagon = (function(_super) {
  ...
  function Hexagon() {
    _ref25 = Hexagon.__super__.constructor.apply(this, arguments);
    return _ref25;
  }
...
Septagon = (function(_super) {
  ...
  function Septagon() {
    _ref26 = Septagon.__super__.constructor.apply(this, arguments);
    return _ref26;
  }
...
Octogon = (function(_super) {
  ...
  function Octogon() {
    _ref27 = Octogon.__super__.constructor.apply(this, arguments);
    return _ref27;
  }
...
Star = (function(_super) {
  ...
  function Star() {
    _ref28 = Star.__super__.constructor.apply(this, arguments);
    return _ref28;
  }
  ...
  Star.prototype.path = function() {
    var angle, h2, i, lh2, lw2, magic, path, w2, _i, _ref29;
    angle = 2 * pi / this.n;
    w2 = this.width() / 2;
    h2 = this.height() / 2;
    magic = 5 * pi / 6;
    ...
    lh2 = h2 / magic;
    path = "M 0 " + (-h2);
    for (i = _i = 0, _ref29 = this.n; 0 <= _ref29 ? _i <= _ref29 : _i >= _ref29; i = 0 <= _ref29 ? ++_i : --_i) {
...
Association = (function(_super) {
  ...
  function Association() {
    _ref29 = Association.__super__.constructor.apply(this, arguments);
    return _ref29;
  }
...
Inheritance = (function(_super) {
  ...
  function Inheritance() {
    _ref30 = Inheritance.__super__.constructor.apply(this, arguments);
    return _ref30;
  }
...
Composition = (function(_super) {
  ...
  function Composition() {
    _ref31 = Composition.__super__.constructor.apply(this, arguments);
    return _ref31;
  }
...
Comment = (function(_super) {
  ...
  function Comment() {
    _ref32 = Comment.__super__.constructor.apply(this, arguments);
    return _ref32;
  }
...
Aggregation = (function(_super) {
  ...
  function Aggregation() {
    _ref33 = Aggregation.__super__.constructor.apply(this, arguments);
    return _ref33;
  }
...
Group = (function(_super) {
  ...
  function Group() {
    _ref34 = Group.__super__.constructor.apply(this, arguments);
    return _ref34;
  }

  Group.prototype.contains = function(elt) {
    var h2, w2, _ref35, _ref36;
    w2 = this.width() / 2;
    h2 = this.height() / 2;
    return (this.x - w2 < (_ref35 = elt.x) && _ref35 < this.x + w2) && (this.y - h2 < (_ref36 = elt.y) && _ref36 < this.y + h2);
  };
...
Diagrams.FlowChart = (function(_super) {
  ...
  function FlowChart() {
    _ref35 = FlowChart.__super__.constructor.apply(this, arguments);
    return _ref35;
  }
...
E.Process = (function(_super) {
  ...
  function Process() {
    _ref36 = Process.__super__.constructor.apply(this, arguments);
    return _ref36;
  }
...
E.IO = (function(_super) {
  ...
  function IO() {
    _ref37 = IO.__super__.constructor.apply(this, arguments);
    return _ref37;
  }
...
E.Terminator = (function(_super) {
  ...
  function Terminator() {
    _ref38 = Terminator.__super__.constructor.apply(this, arguments);
    return _ref38;
  }
...
E.Decision = (function(_super) {
  ...
  function Decision() {
    _ref39 = Decision.__super__.constructor.apply(this, arguments);
    return _ref39;
  }
...
E.SubProcess = (function(_super) {
  ...
  function SubProcess() {
    _ref40 = SubProcess.__super__.constructor.apply(this, arguments);
    return _ref40;
  }
...
E.Document = (function(_super) {
  ...
  function Document() {
    _ref41 = Document.__super__.constructor.apply(this, arguments);
    return _ref41;
  }
...
E.Database = (function(_super) {
  ...
  function Database() {
    _ref42 = Database.__super__.constructor.apply(this, arguments);
    return _ref42;
  }
...
E.HardDisk = (function(_super) {
  ...
  function HardDisk() {
    _ref43 = HardDisk.__super__.constructor.apply(this, arguments);
    return _ref43;
  }
...
E.Preparation = (function(_super) {
  ...
  function Preparation() {
    _ref44 = Preparation.__super__.constructor.apply(this, arguments);
    return _ref44;
  }
...
E.InternalStorage = (function(_super) {
  ...
  function InternalStorage() {
    _ref45 = InternalStorage.__super__.constructor.apply(this, arguments);
    return _ref45;
  }
...
Diagrams.FlowChart.prototype.types.links.Flow = (function(_super) {
  ...
  function Flow() {
    _ref46 = Flow.__super__.constructor.apply(this, arguments);
    return _ref46;
  }
...
Diagrams.FlowChart.prototype.types.groups.Container = (function(_super) {
  ...
  function Container() {
    _ref47 = Container.__super__.constructor.apply(this, arguments);
    return _ref47;
  }
...
Diagrams.Dot = (function(_super) {
  ...
  Dot.prototype.to_dot = function() {
    var attrs, directed, dot, element, key, link, marker_to_dot, op, shape, val, _i, _j, _len, _len1, _ref48, _ref49, _ref50, _ref51;
    directed = false;
    dot = "graph umlaut {\n";
    _ref48 = diagram.elements;
    ...
    _ref50 = diagram.links;
    for (_j = 0, _len1 = _ref50.length; _j < _len1; _j++) {
      link = _ref50[_j];
      if (!link.marker_end) {
        op = '--';
      } else {
...
E.Box = (function(_super) {
  ...
  function Box() {
    _ref48 = Box.__super__.constructor.apply(this, arguments);
    return _ref48;
  }
...
E.Polygon = (function(_super) {
  ...
  function Polygon() {
    _ref49 = Polygon.__super__.constructor.apply(this, arguments);
    return _ref49;
  }
...
E.Ellipse = (function(_super) {
  ...
  function Ellipse() {
    _ref50 = Ellipse.__super__.constructor.apply(this, arguments);
    return _ref50;
  }
...
E.Oval = (function(_super) {
  ...
  function Oval() {
    _ref51 = Oval.__super__.constructor.apply(this, arguments);
    return _ref51;
  }
...
E.Circle = (function(_super) {
  ...
  function Circle() {
    _ref52 = Circle.__super__.constructor.apply(this, arguments);
    return _ref52;
  }
...
E.Triangle = (function(_super) {
  ...
  function Triangle() {
    _ref53 = Triangle.__super__.constructor.apply(this, arguments);
    return _ref53;
  }
...
E.Plaintext = (function(_super) {
  ...
  function Plaintext() {
    _ref54 = Plaintext.__super__.constructor.apply(this, arguments);
    return _ref54;
  }
...
E.Diamond = (function(_super) {
  ...
  function Diamond() {
    _ref55 = Diamond.__super__.constructor.apply(this, arguments);
    return _ref55;
  }
...
E.Trapezium = (function(_super) {
  ...
  function Trapezium() {
    _ref56 = Trapezium.__super__.constructor.apply(this, arguments);
    return _ref56;
  }
...
E.Parallelogram = (function(_super) {
  ...
  function Parallelogram() {
    _ref57 = Parallelogram.__super__.constructor.apply(this, arguments);
    return _ref57;
  }
...
E.House = (function(_super) {
  ...
  function House() {
    _ref58 = House.__super__.constructor.apply(this, arguments);
    return _ref58;
  }
...
E.Pentagon = (function(_super) {
  ...
  function Pentagon() {
    _ref59 = Pentagon.__super__.constructor.apply(this, arguments);
    return _ref59;
  }
...
E.Hexagon = (function(_super) {
  ...
  function Hexagon() {
    _ref60 = Hexagon.__super__.constructor.apply(this, arguments);
    return _ref60;
  }
...
E.Septagon = (function(_super) {
  ...
  function Septagon() {
    _ref61 = Septagon.__super__.constructor.apply(this, arguments);
    return _ref61;
  }
...
E.Octogon = (function(_super) {
  ...
  function Octogon() {
    _ref62 = Octogon.__super__.constructor.apply(this, arguments);
    return _ref62;
  }
...
E.Rect = (function(_super) {
  ...
  function Rect() {
    _ref63 = Rect.__super__.constructor.apply(this, arguments);
    return _ref63;
  }
...
E.Rectangle = (function(_super) {
  ...
  function Rectangle() {
    _ref64 = Rectangle.__super__.constructor.apply(this, arguments);
    return _ref64;
  }
...
E.Square = (function(_super) {
  ...
  function Square() {
    _ref65 = Square.__super__.constructor.apply(this, arguments);
    return _ref65;
  }
...
E.Star = (function(_super) {
  ...
  function Star() {
    _ref66 = Star.__super__.constructor.apply(this, arguments);
    return _ref66;
  }
...
E.Underline = (function(_super) {
  ...
  function Underline() {
    _ref68 = Underline.__super__.constructor.apply(this, arguments);
    return _ref68;
  }
...
E.Note = (function(_super) {
  ...
  function Note() {
    _ref69 = Note.__super__.constructor.apply(this, arguments);
    return _ref69;
  }
...
L.Link = (function(_super) {
  ...
  function Link() {
    _ref70 = Link.__super__.constructor.apply(this, arguments);
    return _ref70;
  }
...
Diagrams.UseCase.prototype.types.elements.Case = (function(_super) {
  ...
  function Case() {
    _ref71 = Case.__super__.constructor.apply(this, arguments);
    return _ref71;
  }
...
Diagrams.UseCase.prototype.types.groups.System = (function(_super) {
  ...
  function System() {
    _ref72 = System.__super__.constructor.apply(this, arguments);
    return _ref72;
  }
...
Diagrams.UseCase.prototype.types.links.Association = (function(_super) {
  ...
  function Association() {
    _ref73 = Association.__super__.constructor.apply(this, arguments);
    return _ref73;
  }
...
Diagrams.UseCase.prototype.types.links.Inheritance = (function(_super) {
  ...
  function Inheritance() {
    _ref74 = Inheritance.__super__.constructor.apply(this, arguments);
    return _ref74;
  }
...
Diagrams.UseCase.prototype.types.links.Aggregation = (function(_super) {
  ...
  function Aggregation() {
    _ref75 = Aggregation.__super__.constructor.apply(this, arguments);
    return _ref75;
  }
...
Diagrams.UseCase.prototype.types.links.Composition = (function(_super) {
  ...
  function Composition() {
    _ref76 = Composition.__super__.constructor.apply(this, arguments);
    return _ref76;
  }
...
Diagrams.UseCase.prototype.types.links.Comment = (function(_super) {
  ...
  function Comment() {
    _ref77 = Comment.__super__.constructor.apply(this, arguments);
    return _ref77;
  }
...
Electric = (function(_super) {
  ...
  function Electric() {
    _ref78 = Electric.__super__.constructor.apply(this, arguments);
    return _ref78;
  }
...
E.Resistor = (function(_super) {
  ...
  function Resistor() {
    _ref79 = Resistor.__super__.constructor.apply(this, arguments);
    return _ref79;
  }
...
E.Diode = (function(_super) {
  ...
  function Diode() {
    _ref80 = Diode.__super__.constructor.apply(this, arguments);
    return _ref80;
  }
...
E.Battery = (function(_super) {
  ...
  function Battery() {
    _ref81 = Battery.__super__.constructor.apply(this, arguments);
    return _ref81;
  }
...
E.PNPTransistor = (function(_super) {
  ...
  function PNPTransistor() {
    _ref82 = PNPTransistor.__super__.constructor.apply(this, arguments);
    return _ref82;
  }
...
E.NPNTransistor = (function(_super) {
  ...
  function NPNTransistor() {
    _ref83 = NPNTransistor.__super__.constructor.apply(this, arguments);
    return _ref83;
  }
...
Diagrams.Electric.prototype.types.links.Wire = (function(_super) {
  ...
  function Wire() {
    _ref84 = Wire.__super__.constructor.apply(this, arguments);
    return _ref84;
  }
...
Diagrams.Class.prototype.types.elements.Note = (function(_super) {
  ...
  function Note() {
    _ref85 = Note.__super__.constructor.apply(this, arguments);
    return _ref85;
  }
...
Diagrams.Class.prototype.types.elements.Class = (function(_super) {
  ...
  function Class() {
    _ref86 = Class.__super__.constructor.apply(this, arguments);
    return _ref86;
  }
...
Diagrams.Class.prototype.types.groups.System = (function(_super) {
  ...
  function System() {
    _ref87 = System.__super__.constructor.apply(this, arguments);
    return _ref87;
  }
...
L.Association = (function(_super) {
  ...
  function Association() {
    _ref88 = Association.__super__.constructor.apply(this, arguments);
    return _ref88;
  }
...
L.Inheritance = (function(_super) {
  ...
  function Inheritance() {
    _ref89 = Inheritance.__super__.constructor.apply(this, arguments);
    return _ref89;
  }
...
L.Aggregation = (function(_super) {
  ...
  function Aggregation() {
    _ref90 = Aggregation.__super__.constructor.apply(this, arguments);
    return _ref90;
  }
...
L.Composition = (function(_super) {
  ...
  function Composition() {
    _ref91 = Composition.__super__.constructor.apply(this, arguments);
    return _ref91;
  }
...
L.Comment = (function(_super) {
  ...
  function Comment() {
    _ref92 = Comment.__super__.constructor.apply(this, arguments);
    return _ref92;
  }
...
commands = {
  ...
  edit: {
    fun: function() {
      return edit((function() {
        ...
        var node, _i, _len, _ref93, _results;
  ...
  remove: {
    fun: function() {
      var lnk, node, _i, _j, _len, _len1, _ref93, _ref94;
      _ref93 = diagram.selection;
      for (_i = 0, _len = _ref93.length; _i < _len; _i++) {
        node = _ref93[_i];
        ...
        _ref94 = diagram.links.slice();
        for (_j = 0, _len1 = _ref94.length; _j < _len1; _j++) {
          lnk = _ref94[_j];
  ...
  "switch": {
    fun: function() {
      var link, node, _i, _j, _len, _len1, _ref93, _ref94, _ref95, _ref96;
      _ref93 = diagram.selection;
      for (_i = 0, _len = _ref93.length; _i < _len; _i++) {
        node = _ref93[_i];
        if (node instanceof Link) {
          _ref94 = [node.target, node.source], node.source = _ref94[0], node.target = _ref94[1];
        }
        if (node instanceof Element) {
          _ref95 = diagram.links;
          for (_j = 0, _len1 = _ref95.length; _j < _len1; _j++) {
            link = _ref95[_j];
            _ref96 = [link.target, link.source], link.source = _ref96[0], link.target = _ref96[1];
          }
        }
      }
      return svg.tick();
...
init_commands = function() {
  var cls, conf, e1, e2, element, first, fun, hotkey, i, icon, inc, key, link, margin, name, svgicon, taken_hotkeys, val, way, _ref93, _ref94, _ref95, _ref96, _results;
  _ref93 = diagram.force_conf;
  for (conf in _ref93) {
    val = _ref93[conf];
    _ref94 = {
      increase: 1.1,
...
edit = function(getter, setter) {
  ...
  textarea.on('input', function() {
    var val;
    setter(((function() {
      var _i, _len, _ref93, _results;
      _ref93 = this.value.split('\n');
      _results = [];
      for (_i = 0, _len = _ref93.length; _i < _len; _i++) {
        val = _ref93[_i];
        _results.push(val || ' ');
...
move_drag = d3.behavior.drag().origin(function(i) {
  ...
  var delta, nod, x, y, _i, _j, _len, _len1, _ref93, _ref94, _ref95;
  x = diagram.force ? 'px' : 'x';
  y = diagram.force ? 'py' : 'y';
  if (_ref93 = !node, __indexOf.call(diagram.selection, _ref93) >= 0) {
    diagram.selection.push(node);
  }
  _ref94 = diagram.selection;
  for (_i = 0, _len = _ref94.length; _i < _len; _i++) {
    nod = _ref94[_i];
    nod.fixed = true;
  }
  if (d3.event.sourceEvent.shiftKey) {
...
mouse_node = function(nodes) {
  return nodes.on('dblclick', function(node) {
    return edit((function() {
      return node.text;
    }), (function(txt) {
...
mouse_link = function(link) {
  return link.on('dblclick', function(lnk) {
    var nearest;
...
write_text = function(txt, text) {
  var i, line, tspan, _i, _len, _ref93, _results;
  txt.selectAll('tspan').remove();
  _ref93 = text.split('\n');
  _results = [];
  for (i = _i = 0, _len = _ref93.length; _i < _len; i = ++_i) {
    line = _ref93[i];
...
enter_link = function(links, connect) {
  ...
  g.append("path").attr('class', function(link) {
    ...
    var _ref93;
    return "url(#" + (((_ref93 = link.marker_start) != null ? _ref93.id : void 0) || link.cls.marker_start.id) + ")";
  }).attr("marker-end", function(link) {
    var _ref93;
    return "url(#" + (((_ref93 = link.marker_end) != null ? _ref93.id : void 0) || link.cls.marker_end.id) + ")";
  });
...
update_link = function(links) {
  links.each(function(link) {
    var _ref93, _ref94;
    return d3.select(this).selectAll('path').attr('d', link.path()).attr("marker-start", "url(#" + (((_ref94 = link.marker_start) != null ? _ref94.id : void 0) || link.cls.marker_start.id) + ")").attr("marker-end", "url(#" + (((_ref93 = link.marker_end) != null ? _ref93.id : void 0) || link.cls.marker_end.id) + ")");
  });
  links.each(function(link) {
    var g, txt;
    g = d3.select(this);
...
RemoteStorage = (function() {
  ...
  RemoteStorage.prototype.getItem = function(k, callback) {
    var key;
  ...
  RemoteStorage.prototype.setItem = function(k, v, callback) {
    var form, iframe, input, key;
    key = btoa(k).replace(/\=/g, '_');
...
publish = function(k, b64, callback) {
  var key;
  key = "umlaut_" + (k.replace('|', '-_-'));
  return remoteStorage.getItem('umlaut_key_list', function(list) {
    list = JSON.parse(list) || [];
    if (__indexOf.call(list, key) < 0) {
      list.push(key);
    }
    return remoteStorage.setItem(key, b64, function() {
      return remoteStorage.setItem('umlaut_key_list', JSON.stringify(list), callback);
    });
  });
};
...
list_local = function() {
  var $tbody, $tr, b64_diagram, key, title, type, _ref93;
  $tbody = $('.table.local tbody');
  $tbody.find('tr').remove();
  $('.local').show();
  for (key in localStorage) {
    b64_diagram = localStorage[key];
    _ref93 = key.split('|'), type = _ref93[0], title = _ref93[1];
    if (title == null) {
      continue;
    }
    $tbody.append($tr = $('<tr>'));
    ...
    })).on('click', (function(k, b64) {
      return function() {
        publish(k, b64, list_remote);
        return false;
      };
    })(key, b64_diagram))).append($('<a>').attr('href', "#").append($('<i>', {
...
list_remote = function() {
  ...
  return remoteStorage.getItem('umlaut_key_list', function(list) {
    ...
    for (_i = 0, _len = list.length; _i < _len; _i++) {
      key = list[_i];
      _results.push(remoteStorage.getItem(key, function(b64_diagram, key_) {
        var $tr, title, type, _ref93;
        _ref93 = key_.slice(7).split('-_-'), type = _ref93[0], title = _ref93[1];
        if (title == null) {
          return;
        }
        $tbody.append($tr = $('<tr>'));
        return $tr.append($('<td>').text(title), $('<td>').text((new (Diagrams._get(type))()).label), $('<td>').append($('<a>').attr('href', "#" + b64_diagram).append($('<i>', {
...
Keyword = (function(_super) {
  ...
  function Keyword() {
    _ref93 = Keyword.__super__.constructor.apply(this, arguments);
    return _ref93;
  }
...
Id = (function(_super) {
  ...
  function Id() {
    _ref94 = Id.__super__.constructor.apply(this, arguments);
    return _ref94;
  }
...
Number = (function(_super) {
  ...
  function Number() {
    _ref95 = Number.__super__.constructor.apply(this, arguments);
    return _ref95;
  }
...
QuotedId = (function(_super) {
  ...
  function QuotedId() {
    _ref96 = QuotedId.__super__.constructor.apply(this, arguments);
    return _ref96;
  }
...
Brace = (function(_super) {
  ...
  function Brace() {
    _ref97 = Brace.__super__.constructor.apply(this, arguments);
    return _ref97;
  }
...
Delimiter = (function(_super) {
  ...
  function Delimiter() {
    _ref98 = Delimiter.__super__.constructor.apply(this, arguments);
    return _ref98;
  }
...
Assign = (function(_super) {
  ...
  function Assign() {
    _ref99 = Assign.__super__.constructor.apply(this, arguments);
    return _ref99;
  }
...
Operator = (function(_super) {
  ...
  function Operator() {
    _ref100 = Operator.__super__.constructor.apply(this, arguments);
    return _ref100;
  }
...
dot_tokenize = function(s) {
  var chr, col, escape, id, last_chr, len, op, pos, row, token, tokens, _ref101, _ref102;
  pos = 0;
  row = 0;
  col = 0;
  len = s.length;
  ...
  while (pos < len) {
    ...
    if (chr.match(RE_SPACE)) {
      ...
      id = chr;
      while ((_ref101 = (chr = s[pos++])) != null ? _ref101.match(RE_ALPHADIGIT) : void 0) {
        id += chr;
      }
      pos--;
      ...
      id = chr;
      while ((_ref102 = (chr = s[pos++])) != null ? _ref102.match(RE_DIGIT) : void 0) {
        id += chr;
      }
      pos--;
...
Statement = (function() {
  ...
  Statement.prototype.get_attrs = function() {
    var attribute, attrs, _i, _len, _ref101;
    attrs = {};
    _ref101 = this.attributes;
    for (_i = 0, _len = _ref101.length; _i < _len; _i++) {
      attribute = _ref101[_i];
...
dot_lex = function(tokens) {
  ...
  parse_node = function() {
    var compass_pt, node, port, _ref101;
    if (tokens[pos] instanceof Keyword && tokens[pos].value === 'subgraph') {
      node = parse_subgraph();
      ...
      if (tokens[pos + 1] instanceof Delimiter && tokens[pos + 1].value === ':') {
        ...
        if (tokens[pos + 1] instanceof Delimiter && tokens[pos + 1].value === ':') {
          pos += 2;
          if (!(tokens[pos] instanceof Id) || (_ref101 = tokens[pos].value, __indexOf.call(COMPASS_PTS, _ref101) < 0)) {
  ...
  parse_statement = function() {
    var left, statement, _ref101;
    if (tokens[pos] instanceof Brace && tokens[pos].value === '}') {
      return null;
    }
    if (tokens[pos] instanceof Keyword && tokens[pos].value !== 'subgraph') {
      if ((_ref101 = tokens[pos].value) !== 'graph' && _ref101 !== 'node' && _ref101 !== 'edge') {
...
dot = function(src) {
  var attributes, copy_attributes, d, e, elements_by_id, elt, fixed, graph, id, l, links_by_id, lnk, nodes_by_id, populate, tokens, x, y, _i, _len, _ref101;
  ...
  populate = function(statements) {
    ...
    for (_i = 0, _len = statements.length; _i < _len; _i++) {
      ...
      _results.push((function() {
        var _j, _len1, _ref101, _results1;
        _ref101 = statement.nodes;
        _results1 = [];
        for (i = _j = 0, _len1 = _ref101.length; _j < _len1; i = ++_j) {
          node = _ref101[i];
          ...
          if (i !== 0) {
            ...
            if (prev_node instanceof SubGraph) {
              _results1.push((function() {
                var _k, _len2, _ref102, _results2;
                _ref102 = prev_node.statements;
                _results2 = [];
                for (_k = 0, _len2 = _ref102.length; _k < _len2; _k++) {
                  sub_prev_statement = _ref102[_k];
                  _results2.push((function() {
                    var _l, _len3, _ref103, _results3;
                    _ref103 = sub_prev_statement.nodes;
                    _results3 = [];
                    for (_l = 0, _len3 = _ref103.length; _l < _len3; _l++) {
                      sub_prev_node = _ref103[_l];
                      if (node instanceof SubGraph) {
                        _results3.push((function() {
                          var _len4, _m, _ref104, _results4;
                          _ref104 = node.statements;
                          _results4 = [];
                          for (_m = 0, _len4 = _ref104.length; _m < _len4; _m++) {
                            sub_statement = _ref104[_m];
                            _results4.push((function() {
                              var _len5, _n, _ref105, _results5;
                              _ref105 = sub_statement.nodes;
                              _results5 = [];
                              for (_n = 0, _len5 = _ref105.length; _n < _len5; _n++) {
                                sub_node = _ref105[_n];
              ...
              if (node instanceof SubGraph) {
                _results1.push((function() {
                  var _k, _len2, _ref102, _results2;
                  _ref102 = node.statements;
                  _results2 = [];
                  for (_k = 0, _len2 = _ref102.length; _k < _len2; _k++) {
                    sub_statement = _ref102[_k];
                    _results2.push((function() {
                      var _l, _len3, _ref103, _results3;
                      _ref103 = sub_statement.nodes;
                      _results3 = [];
                      for (_l = 0, _len3 = _ref103.length; _l < _len3; _l++) {
                        sub_node = _ref103[_l];
                        _results3.push(links_by_id.push({
  ...
  for (id in nodes_by_id) {
    ...
    if (elt.attrs.pos) {
      ...
      _ref101 = elt.attrs.pos.split(','), x = _ref101[0], y = _ref101[1];
      e.x = +x;
      e.y = +y;
